 ...
 */
public class PropagationSupportsTest extends AbstractPropagationTest {
    ...
    public void tran_rollback_test_1() throws Throwable {
        try (DruidDataSource dataSource = DsUtils.mysqlDataSource();//
            ...
            /* T2 */
            TransactionStatus tran2 = tranManager.getTransaction(Propagation.SUPPORTS, Isolation.REPEATABLE_READ);

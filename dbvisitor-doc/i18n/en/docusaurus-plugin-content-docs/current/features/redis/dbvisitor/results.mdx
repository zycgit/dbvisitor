...
## Custom result handling {#result-handlers}

See [Result Handling](./result-handling.md) for API availability and configuration of `RowMapper`, `RowCallbackHandler`, and `ResultSetExtractor`. Read the actual result columns listed above.

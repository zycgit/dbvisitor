...
Assigned keys, IDENTITY / SERIAL key retrieval, and composite keys are supported. Method annotations configure retrieval with `useGeneratedKeys` and `keyProperty`; BaseMapper uses the entity's key configuration.

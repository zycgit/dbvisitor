...
This page shows how dbVisitor APIs execute the adapter's SQL subset. See [Install and Use](../../drivers/milvus/usecase.mdx) for dependencies, connections, TLS and a complete JDBC program, and the [support matrix](../../drivers/milvus/compatibility.md) for versions and unverified environments. Examples use two-dimensional FloatVector fields; the application supplies dataSource, connection, entity accessors and Session.

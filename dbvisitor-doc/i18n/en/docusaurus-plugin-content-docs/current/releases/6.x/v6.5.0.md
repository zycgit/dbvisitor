...
- Refactoring
  ...
  - **Class Hierarchy Simplification**: Removed the standalone SQL/Mongo builder implementations and the glue class `MongoBuilderDialect`, merging command construction into dialects; the `SqlCommandBuilder` interface is retained.

...
title: v6.7.1 (Development)
---

# v6.7.1 (Development)

This page describes development changes, not a stable release announcement. Build SNAPSHOT from source and install it in your local Maven repository before use. See [Release Notes](../latest) for released versions.
...
- Improvements
  ...
  - Reorganized the Chinese and English guides around user tasks and the programmatic, Mapper, and Builder APIs.
- Bug Fixes

...
| selectTemplate     | <TagGray/> For [Fluent API](../../core/lambda/about): column expression in SELECT. Empty = column name. See [Statement templates](../mapping/statement_template). |
| insertTemplate     | <TagGray/> For [Fluent API](../../core/lambda/about): argument expression in INSERT, default `?`. See [Statement templates](../mapping/statement_template). |
| setValueTemplate   | <TagGray/> For [Fluent API](../../core/lambda/about): argument expression in UPDATE SET, default `?`. See [Statement templates](../mapping/statement_template). |
| whereColTemplate   | <TagGray/> For [Fluent API](../../core/lambda/about): column expression in WHERE (update/delete). Empty = column name. See [Statement templates](../mapping/statement_template). |
| whereValueTemplate | <TagGray/> For [Fluent API](../../core/lambda/about): argument expression in WHERE (update/delete), default `?`. See [Statement templates](../mapping/statement_template). |
| orderByColTemplate | <TagGray/> For [Fluent API](../../core/lambda/about): column expression in ORDER BY. Empty = column name. See [Statement templates](../mapping/statement_template). |

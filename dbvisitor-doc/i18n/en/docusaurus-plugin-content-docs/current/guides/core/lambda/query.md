...
:::info[Tip]
Pagination depends on dialect support; see **[database support](../../api/differences#dialect)** for supported databases.
:::
...
- The Page object has more helpers; see [Page object](../global/page).

...
:::info[Tip]
For building conditions during updates, see **[where builder](./where_builder)**.
:::
...
Replacing the entire row is a dangerous operation that overwrites all columns with the provided data.

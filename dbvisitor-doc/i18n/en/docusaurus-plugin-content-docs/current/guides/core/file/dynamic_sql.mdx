...
- [&lt;choose&gt; / &lt;when&gt; / &lt;otherwise&gt;](./dynamic#choose): multi-branch condition selection.
- [&lt;trim&gt; / &lt;where&gt; / &lt;set&gt;](./dynamic#trim): help avoid malformed SQL when generating specific statements.
- [&lt;foreach&gt;](./dynamic#foreach): iterate collections.
- [&lt;bind&gt;](./dynamic#bind): create variables via OGNL expressions and bind them to the context.

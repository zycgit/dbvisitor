...
The `TransactionManager` interface is the core of dbVisitor transaction management. Annotation-based transactions and transaction templates eventually call its `begin`, `commit`, and `rollBack` methods.

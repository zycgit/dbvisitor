...
:::info
The following examples show the capabilities of different `SqlArgSource` types.
:::
...
In the Declarative API ([Method Annotations](../core/mapper/about#method-annotations)), use the `@Param` annotation to name method parameters so they can be referenced by name in SQL.

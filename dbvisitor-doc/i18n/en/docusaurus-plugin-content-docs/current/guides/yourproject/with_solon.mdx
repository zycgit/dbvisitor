...
Solon is a lightweight Java application framework that provides dependency injection, configuration, web, transaction, and plugin extension capabilities.
...
| dialect | <TagGray/> **[Database Dialect](../../features/differences/builder)** used by default. |

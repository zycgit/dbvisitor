...
# 3.5 Hasor Integration

## What is Hasor

Hasor is a lightweight Java application framework that provides IoC, AOP, web development, and modular extension capabilities.
...
First, add the dependency, guide version: <Highlight color="rgb(227 17 108)">{Vars.docsVersion}</Highlight>
...
// Create the data source, configure dbVisitor, and register mappers
...
- TransactionManager interface, interface for developing [Programmatic](../transaction/program) transactions
- TransactionTemplate interface, interface for developing [Template](../transaction/template) transactions
- Configuration class
- Session class
- Custom Mapper
...
- net.hasor.dbvisitor.jdbc.JdbcTemplate
...
| dbvisitor.dialect | <TagGray/> **[Database Dialect](../../features/differences/builder)** used by default. |

...
- [Dynamic SQL](../../core/file/dynamic_sql) tags in Mapper Files, `Statement.RETURN_GENERATED_KEYS` (auto-retrieval of `_id`)
...
:::tip[Tip]
All [annotations provided by the core API](../../core/mapper/about#method-annotations) work on ElasticSearch data sources, except for the `@Call` annotation.
:::

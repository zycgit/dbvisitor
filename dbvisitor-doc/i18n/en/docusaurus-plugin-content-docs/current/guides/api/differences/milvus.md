...
:::tip[Tip]
All [annotations provided by the core API](../../core/mapper/about#method-annotations) work on Milvus data sources, except for the `@Call` annotation.
...
For complete vector query documentation, see [Vector Query](../../core/vector_query/about).

...
- **Database Dialect** — when using the [Fluent API](../lambda), the same API generates different commands or syntax for different databases.
...
dbVisitor has designed 4 types of APIs under a unified kernel architecture: [Programmatic API](../jdbc), [Declarative API](../mapper), [Fluent API](../lambda), and [Mapper File](../file_mapper).

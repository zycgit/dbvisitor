...
- [Dynamic SQL](../../core/file/dynamic_sql) tags in Mapper Files
...
:::tip[Tip]
All [annotations provided by the core API](../../core/mapper/about#method-annotations) work on Redis data sources, except for the `@Call` annotation.
:::

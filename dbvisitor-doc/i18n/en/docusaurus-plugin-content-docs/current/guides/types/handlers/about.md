...
1. `<JavaTypeName>TypeHandler` or `<JDBCTypeName>TypeHandler` — directly corresponds to a Java/JDBC type
...
| -                                     | java.lang.Number              | NumberTypeHandler **(read-only)**          |

...
After [Next-Gen Data Access: dbVisitor](/blog/new-generation-dbvisitor) went live, the core debate was direct: **can a single API truly unify RDBMS and NoSQL?** This post tackles the controversy and explains the design principles behind dbVisitor's "One APIs Access Any DataBase" vision.

...
"Select two columns and build a Map" is a common pattern — ID-to-name, code-to-description, etc. The builder-level `queryForPairs` added in dbVisitor 6.7.0 returns a `Map<K, V>` directly in one call, no manual iteration needed.

...
| `BytesAsBytesWrapTypeHandler` | `java.lang.Byte[]` | 以 getBytes/setBytes 方式处理 Byte[] 包装类型数据 |
| `BlobAsBytesTypeHandler` | `byte[]` | 以 getBlob/setBlob 方式处理 byte[] 数据 |
| `BlobAsBytesWrapTypeHandler` | `java.lang.Byte[]` | 以 getBlob/setBlob 方式处理 Byte[] 包装类型数据 |

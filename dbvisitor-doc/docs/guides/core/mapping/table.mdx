...
| selectTemplate     | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 select 语句时列名的写法。默认是空，表示列名本身。详细请了解 [语句模版](../mapping/statement_template)。                |
| insertTemplate     | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 insert 语句时参数写法，默认是 ?。详细请了解 [语句模版](../mapping/statement_template)。                       |
| setValueTemplate   | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 update set 语句时参数写法，默认是 ?。详细请了解 [语句模版](../mapping/statement_template)。                   |
| whereColTemplate   | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 update/delete 的 where 语句时列名的写法。默认是空，表示列名本身。详细请了解 [语句模版](../mapping/statement_template)。 |
| whereValueTemplate | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 update/delete 的 where 语句时参数写法，默认是 ?。详细请了解 [语句模版](../mapping/statement_template)。        |
| orderByColTemplate | <TagGray/> 仅对 [构造器 API](../../core/lambda/about) 有效。当用作 order by 语句时列名的写法。默认是空，表示列名本身。详细请了解 [语句模版](../mapping/statement_template)。              |

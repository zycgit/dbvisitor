...
title: BaseMapper 接口
description: 介绍如何使用 BaseMapper 接口简化 ElasticSearch 的 CRUD 操作。
---

# BaseMapper 接口

`BaseMapper` 是 dbVisitor 提供的一个通用 Mapper 接口，它内置了常用的 CRUD 方法。通过继承该接口，你可以直接获得对 ElasticSearch 索引的基本操作能力，而无需编写任何 SQL 或 Elastic 命令。

...
- [jdbc-mongo 驱动](../../features/mongo/dbvisitor/results.mdx)
- [jdbc-redis 驱动](../../features/redis/dbvisitor/results.mdx)

## 更新内容

- 新增
  - 新增 [jdbc-mongo](../../drivers/mongo/about) 驱动，支持使用 JDBC 协议操作 MongoDB。
  - 在 [Mapper 注解化](../../guides/core/mapper/about)、[Mapper File](../../guides/core/file/about)、[JdbcTemplate](../../guides/core/jdbc/about) 级别 API 上适配 jdbc-mongo 驱动。
  - 支持使用 [LambdaTemplate](../../guides/core/lambda/about) 进行类型安全的 MongoDB 操作。
  - 支持 MongoDB 的常用命令，包括 CRUD、聚合、索引管理等。
  - 支持在 Mapper File 中使用 [动态 SQL](../../guides/core/file/dynamic_sql) 标签生成 MongoDB 执行命令。
...
- [MongoDB ORM/ODM 最佳实践](../../../blog/mongodb-orm-odm-tool)
- [Mongo 驱动文档](../../drivers/mongo/about)

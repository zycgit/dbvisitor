...
- 新增
  - 在 [Mapper 注解化](../../guides/core/mapper/about)、[Mapper File](../../guides/core/file/about)、[JdbcTemplate](../../guides/core/jdbc/about) 级别 API 上适配 jdbc-redis 驱动。
...
## 相关阅读
- [Redis 驱动文档](../../drivers/redis/about)

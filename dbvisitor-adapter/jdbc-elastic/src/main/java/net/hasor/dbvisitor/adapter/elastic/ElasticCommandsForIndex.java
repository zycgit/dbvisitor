...
class ElasticCommandsForIndex extends ElasticCommands {
    ...
    protected static final JdbcColumn COL_SOURCE_STRING   = new JdbcColumn("SOURCE", AdapterType.String, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);
    protected static final JdbcColumn COL_ALIASES_BOOLEAN = new JdbcColumn("ALIASES", AdapterType.Boolean, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);
    protected static final JdbcColumn COL_MAPPING_STRING  = new JdbcColumn("MAPPING", AdapterType.String, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);
    ...
    protected static final JdbcColumn COL_NESTED_BOOLEAN  = new JdbcColumn("NESTED", AdapterType.Boolean, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);
    protected static final JdbcColumn COL_OPTION_JSON     = new JdbcColumn("OPTION", AdapterType.String, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);
    protected static final JdbcColumn COL_SETTING_STRING  = new JdbcColumn("SETTING", AdapterType.String, "", "", "", ResultSetMetaData.columnNullableUnknown, false, AdapterType.Array);

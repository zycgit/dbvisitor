...
|-----------------------------------------------------------------------------|-----------|----------|--------------------------------------------------------------------------------------------------|
| Hash command set                                                            |           |          |                                                                                                  |
| [HDEL](https://redis.io/docs/latest/commands/hdel/)                         | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| [HKEYS](https://redis.io/docs/latest/commands/hkeys/)                       | ResultSet | multiple | KEY field，STRING type                                                                            |
...
| [HSET](https://redis.io/docs/latest/commands/hset/)                         | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [HMSET](https://redis.io/docs/latest/commands/hmset/)                       | ResultSet | 1        | RESULT field，STRING type                                                                         |
| [HSETNX](https://redis.io/docs/latest/commands/hsetnx/)                     | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| [DEL](https://redis.io/docs/latest/commands/del/)                           | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| [EXPIRE](https://redis.io/docs/latest/commands/expire/)                     | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [EXPIREAT](https://redis.io/docs/latest/commands/expireat/)                 | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [EXPIRETIME](https://redis.io/docs/latest/commands/expiretime/)             | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [PEXPIRE](https://redis.io/docs/latest/commands/pexpire/)                   | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [PEXPIREAT](https://redis.io/docs/latest/commands/pexpireat/)               | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| [PERSIST](https://redis.io/docs/latest/commands/persist/)                   | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| [RENAME](https://redis.io/docs/latest/commands/rename/)                     | ResultSet | 1        | RESULT field，STRING type                                                                         |
| [RENAMENX](https://redis.io/docs/latest/commands/renamenx/)                 | ResultSet | 1        | RESULT field，LONG type                                                                           |
| [SCAN](https://redis.io/docs/latest/commands/scan/)                         | ResultSet | multiple | CURSOR field，STRING type<br/>KEY field，STRING type                                               |
| [TOUCH](https://redis.io/docs/latest/commands/touch/)                       | ResultSet | 1        | RESULT field，LONG type                                                                           |
...
| String command set                                                          |           |          |                                                                                                  |
| [SET](https://redis.io/docs/latest/commands/set/)                           | ResultSet | 1        | RESULT field，STRING type (when `GET` not used)、VALUE field，STRING type (when `GET` used)         |

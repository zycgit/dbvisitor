...
class JdbcStatement implements Statement, Closeable {
    ...
    JdbcStatement(JdbcConnection jdbcConn) {
        ...
        this.generatedKeys = jdbcConn.getDefaultGeneratedKeys();
    }
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        ...
        if (result == null) {
            ...
            AdapterCursor generatedKeys = result.toGeneratedKeys();
            return generatedKeys == null ? null : new JdbcResultSet(this, generatedKeys);
        }
    }

...
class JdbcStatement implements Statement, Closeable {
    ...
    protected        String[]           generatedKeyColumns;
    private          String[]           executionKeyColumns;
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        ...
        if (result == null) {
            ...
            return result.generatedKeys(this, this.executionKeyColumns);
        }
    }
    ...
    public synchronized boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        return this.executeWithKeys(sql, autoGeneratedKeys, this.generatedKeyColumns);
    }

    private synchronized boolean executeWithKeys(String sql, int autoGeneratedKeys, String[] columnNames) throws SQLException {
        this.checkOpen();
        ...
        this.executionKeyColumns = autoGeneratedKeys == RETURN_GENERATED_KEYS ? columnNames : null;
    ...
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        this.checkOpen();
        String[] names = copyKeyColumns(columnNames);
        return this.executeWithKeys(sql, names.length == 0 ? NO_GENERATED_KEYS : RETURN_GENERATED_KEYS, names);
    }

    @Override
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        long count = this.executeLargeUpdate(sql, columnNames);
        return (int) count == count ? (int) count : SUCCESS_NO_INFO;
    }
    ...
    static String[] copyKeyColumns(String[] columnNames) throws SQLException {
        if (columnNames == null) {
            throw new SQLException("Generated key column names must not be null.", JdbcErrorCode.SQL_STATE_ILLEGAL_ARGUMENT);
        }
        String[] names = columnNames.clone();
        for (String name : names) {
            if (name == null || name.trim().isEmpty()) {
                throw new SQLException("Generated key column name must not be empty.", JdbcErrorCode.SQL_STATE_ILLEGAL_ARGUMENT);
            }
        }
        return names;
    }

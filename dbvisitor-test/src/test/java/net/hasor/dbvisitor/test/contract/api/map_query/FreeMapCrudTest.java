...
public abstract class FreeMapCrudTest extends AbstractNxnContractTest {
    ...
    public void lambdaFreedomInsertPersistOneUser() throws SQLException {
        int id = baseId() + 11;
    ...
    public void lambdaFreedomQueryUserById() throws SQLException {
        int id = baseId() + 12;
    ...
    public void lambdaFreedomUpdateChangeUser() throws SQLException {
        int id = baseId() + 13;
    ...
    public void lambdaFreedomDeleteRemoveUser() throws SQLException {
        int id = baseId() + 14;

...
import net.hasor.dbvisitor.test.realdb.mongo.material.MongoResultHandlerMapper;
import org.junit.After;
import org.junit.Before;

public class MongoAnnotationMapperScrollableResultTest extends AnnotationMapperScrollableResultCase {
    ...
    public void createResultHandlerMapper() throws Exception {
        this.mapper = this.fixture.session(newConfiguration()).createMapper(MongoResultHandlerMapper.class);
        prepareRows();
    }

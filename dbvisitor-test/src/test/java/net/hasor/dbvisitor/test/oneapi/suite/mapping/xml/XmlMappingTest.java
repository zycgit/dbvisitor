...
public class XmlMappingTest extends AbstractOneApiTest {
    ...
    private static final String XML_RESOURCE = "oneapi/mapping/basic_entity_mapper.xml";
    ...
    public void testLoadMapping_FromInputStream() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/stream_test.xml"), "UTF-8");
    ...
    public void testLoadMapping_EntityMissingType() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/err_missing_type.xml"), "UTF-8");
    ...
    public void testLoadMapping_RootLevelOptions() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_root_level.xml"), "UTF-8");
    ...
    public void testLoadMapping_EntityMissingTable() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/err_missing_table.xml"), "UTF-8");
    ...
    public void testLoadMapping_UnknownProperty() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/err_bad_prop.xml"), "UTF-8");

...
import net.hasor.dbvisitor.test.contract.api.jdbc.JdbcPreparedValueContractTest;
import net.hasor.dbvisitor.test.nxn.env.ClickHouseProfile;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;

public class ClickHouseJdbcPreparedValueContractTest extends JdbcPreparedValueContractTest {
    @Override

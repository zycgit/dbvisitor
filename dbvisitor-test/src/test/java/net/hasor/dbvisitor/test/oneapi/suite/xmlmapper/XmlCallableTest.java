...
public class XmlCallableTest extends AbstractOneApiTest {
    ...
    public void setUp() throws Exception {
        ...
        config.loadMapper("/oneapi/mapper/XmlCallableMapper.xml");
    ...
    public void testCallable_InOnly_InsertUser() throws Exception {
        ...
        session.executeStatement("oneapi.XmlCallableMapper.callInsertUser", params);
    ...
    public void testCallable_Inout_DoubleValue() throws Exception {
        ...
        Object result = session.executeStatement("oneapi.XmlCallableMapper.callDoubleValue", params);
    ...
    public void testCallable_MultiInout_ConcatAndLength() throws Exception {
        ...
        Object result = session.executeStatement("oneapi.XmlCallableMapper.callMultiInout", params);
        assertNotNull(result);
        assertTrue("结果应为 Map", result instanceof Map);
    ...
    public void testCallable_Out_UserCount() throws Exception {
        ...
        Object result = session.executeStatement("oneapi.XmlCallableMapper.callUserCount", params);
        assertNotNull(result);
        assertTrue("结果应为 Map", result instanceof Map);
    ...
    public void testCallable_MultiOut_UserStats() throws Exception {
        ...
        Object result = session.executeStatement("oneapi.XmlCallableMapper.callUserStats", params);
        assertNotNull(result);
        assertTrue("结果应为 Map", result instanceof Map);
    ...
    public void testCallable_Cursor_SingleResultSet() throws Exception {
        ...
        try {
            ...
            Object result = session.executeStatement("oneapi.XmlCallableMapper.callQueryUsers", params);
            assertNotNull(result);
            assertTrue("结果应为 Map", result instanceof Map);
    ...
    public void testCallable_Cursor_MultipleResultSets() throws Exception {
        ...
        try {
            ...
            Object result = session.executeStatement("oneapi.XmlCallableMapper.callQueryUsersMulti", params);
            assertNotNull(result);
            assertTrue("结果应为 Map", result instanceof Map);
    ...
    public void testCallable_NoBind_ReturnsFullResultMap() throws Exception {
        ...
        try {
            ...
            Object result = session.executeStatement("oneapi.XmlCallableMapper.callQueryUsersNoBind", params);
            assertNotNull(result);
            assertTrue("结果应为 Map", result instanceof Map);

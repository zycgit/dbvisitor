...
public class MilvusXmlMapperDynamicRuleContractTest extends XmlMapperDynamicRuleContractTest {
    ...
    public void createXmlMapperSession() throws Exception {
        this.session = this.fixture.session("/realdb/milvus/material/XmlDynamicRuleMapper.xml");
    }

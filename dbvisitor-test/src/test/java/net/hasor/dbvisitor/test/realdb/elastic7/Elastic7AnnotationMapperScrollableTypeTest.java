...
public class Elastic7AnnotationMapperScrollableTypeTest extends AnnotationMapperScrollableTypeCase {
    ...
    public void setup() throws SQLException {
        ...
        for (int i = 1; i <= 10; i++) {
            fixture.insert(baseId() + i, "AttrNxn" + i, 20 + i, "attr-nxn" + i + "@nxn.test");
        }
    }
    ...
    public void createAnnotationMapper() throws Exception {
        this.jdbcTemplate = fixture.open(profile().env());
        this.mapper = fixture.session().createMapper(Elastic7AttributeMapper.class);
    }

    @After
    public void closeAttributeFixture() throws Exception {
        fixture.close();
    }
}

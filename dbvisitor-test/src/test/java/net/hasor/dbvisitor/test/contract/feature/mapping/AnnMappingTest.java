...
@NxnContract
public abstract class AnnMappingTest extends AbstractNxnContractTest {
    ...
    public void annotationMapPrimaryKeyMeta() {
    ...
    public void annotationMapPrimaryKeyMetaPerEntity() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void annotationMapPrimaryKeyPropertyInLambdaConds() throws SQLException {
    ...
    public void annotationMapFieldLevelColMaps() throws SQLException {
        int id = baseId() + 111;
        deleteRaw(id);
    ...
    public void annotationMapColNameAndValueAsEquivalent() throws SQLException {
    ...
    public void annotationMapPrimaryMarkerForDupColMaps() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void resultMapAnnSpaceIdValueAndCustomOverride() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void annotationMapMapQueryResults() throws SQLException {
        int id = baseId() + 114;
    ...
    public void annotationMapDefColsNullsAndEmptyStrings() throws SQLException {
    ...
    public void annotationMapInsertFalseColFromInsert() throws SQLException {
    ...
    public void annotationMapUpdateFalseColFromUpdate() throws SQLException {
    ...
    public void annotationMapInsertFalseAndUpdateFalseAsReadOnly() throws SQLException {
    ...
    public void annotationMapIgnoredFieldFromInsertSelectWhereAndUpdate() throws SQLException {
    ...
    public void annotationMapMultiIgnoredFields() throws SQLException {
    ...
    public void annotationMapLetIgnoreOverrideColAnn() throws SQLException {
    ...
    public void annotationMapHonorIgnoreOnGetterMethod() throws SQLException {
    ...
    public void annotationMapOnlyAnnotatedColsWhenAutoMapFalse() throws SQLException {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void annotationMapExplicitNullValues() throws SQLException {
        int id = baseId() + 51;
    ...
    public void annotationMapPartialEntityInsert() throws SQLException {
    ...
    public void annotationMapOnlyExplicitFields() throws SQLException {
        int id = baseId() + 53;

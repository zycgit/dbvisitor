...
public class ClickHouseTableEngineContractTest extends AbstractNxnContractTest {
    ...
    public ClickHouseTableEngineContractTest(String name, String engine, boolean mutations) {

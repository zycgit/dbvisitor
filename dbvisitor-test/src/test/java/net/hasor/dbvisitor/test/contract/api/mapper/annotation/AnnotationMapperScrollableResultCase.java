...
@NxnContract
public abstract class AnnotationMapperScrollableResultCase extends AnnotationMapperResultHandlerSupport {
    // 能力归属：Mapper API / 执行选项。
    @Test
    @Capability(value = CapabilityId.MAPPER_ANNOTATION_RESULT_HANDLER_EXTRACTOR_OPTIONS, column = "mapper/execution-options/options")

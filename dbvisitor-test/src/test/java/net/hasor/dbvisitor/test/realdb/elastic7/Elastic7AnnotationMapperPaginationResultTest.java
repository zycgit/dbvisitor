...
public class Elastic7AnnotationMapperPaginationResultTest extends AnnotationMapperPaginationResultCase {
    ...
    public void createAnnotationMapper() throws Exception {
        this.jdbcTemplate = fixture.open(profile().env());
        this.mapper = fixture.session().createMapper(Elastic7SessionMapperFixture.NativeResultMapping.class);
    }

    @After
    public void closeMappingFixture() throws Exception {
        fixture.close();
    }
}

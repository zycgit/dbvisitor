...
public class MsSqlXmlMapperCallableContractTest extends XmlMapperCallableContractTest {
    ...
    protected void createCallableDefinitions() throws SQLException {
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_insert_user @p_id INT, @p_name VARCHAR(255) AS " + //
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_multi_inout @p_prefix VARCHAR(255), @p_suffix VARCHAR(255), @p_concat VARCHAR(255) OUTPUT, @p_length INT OUTPUT AS " + //
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_user_stats @p_count INT OUTPUT, @p_max_id INT OUTPUT, @p_min_name VARCHAR(255) OUTPUT AS " + //
                "BEGIN " + //

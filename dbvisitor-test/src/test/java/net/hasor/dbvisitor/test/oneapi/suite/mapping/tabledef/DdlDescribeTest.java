...
import net.hasor.dbvisitor.test.oneapi.model.tabledef.FullDdlEntity;
import net.hasor.dbvisitor.test.oneapi.model.tabledef.NoDdlEntity;
import net.hasor.dbvisitor.test.oneapi.model.tabledef.SimpleDdlEntity;

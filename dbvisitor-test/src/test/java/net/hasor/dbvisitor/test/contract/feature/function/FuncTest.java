...
public abstract class FuncTest extends AbstractNxnContractTest {
    @Before
    ...
    public void queryFunctionScalarValue() throws SQLException {
    ...
    public void queryFunctionNamedParams() throws SQLException {
        requiresNxnFeature(FeatureId.FUNCTION);
    ...
    public void queryFunctionOutParamRecord() throws SQLException {
    ...
    public void queryFunctionTableRows() throws SQLException {
    ...
    public void queryFunctionMissingLookupFallback() throws SQLException {
        requiresNxnFeature(FeatureId.FUNCTION_RECORD_RESULT);
    ...
    public void callFunctionCallableStmtCBAccess() throws SQLException {
    ...
    public void queryFunctionSingleParamSqlArgAndStringTransform() throws SQLException {
        requiresNxnFeature(FeatureId.FUNCTION);

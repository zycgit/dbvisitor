...
public class Elastic6SessionStatementParameterTest extends SessionStatementParameterCase {
    ...
    public void createStatementSession() throws Exception {
        ...
        this.session.getConfiguration().loadMapper("/mapper/elastic/SessionStatementMatrix.xml");
    }

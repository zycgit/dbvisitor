...
import net.hasor.dbvisitor.test.model.registry.CacheEntityA;
import net.hasor.dbvisitor.test.model.registry.CatalogSchemaEntity;
import net.hasor.dbvisitor.test.model.registry.PlainUserNamePojo;

...
@NxnContract
public abstract class InsertDialectTest extends AbstractNxnContractTest {
    ...
    public void generatedKeyStrategy_withoutReturnColsDialect() {
    ...
    public void generatedKeyStrategy_withReturnColsAndIntoDialect() {
    ...
    public void generatedKeyStrategy_withReturnColsAndIgnoreDialect() {
    ...
    public void generatedKeyStrategy_withReturnColsAndUpdateDialect() {
    ...
    public void supportDupStrategyDialect() {

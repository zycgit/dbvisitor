...
import net.hasor.dbvisitor.test.oneapi.handler.UpperCaseTypeHandler;
import net.hasor.dbvisitor.test.oneapi.model.UserInfo;
import net.hasor.dbvisitor.test.oneapi.model.annotation.JdbcTypeUser;
import net.hasor.dbvisitor.test.oneapi.model.annotation.SpecialJavaTypeUser;
import net.hasor.dbvisitor.test.oneapi.model.annotation.TypeHandlerUser;

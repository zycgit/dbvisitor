...
public class H2AnnotationSqlTemplateTest extends AnnotationSqlTemplateCase {
    @Override
    ...
    protected void createSqlTemplateDefinitions() throws SQLException {
        ...
        jdbcTemplate.execute("CREATE ALIAS MD5 FOR '" + H2AnnotationSqlTemplateTest.class.getName() + ".md5'");
    }

...
import net.hasor.dbvisitor.test.oneapi.model.types.ArrayTypesAnnotationModel;
...
public class ArrayTypesAnnotationTest extends AbstractOneApiTest {
    ...
    public void setup() throws IOException, SQLException {
        super.setup();
        // Ensure array_types_annotation_test table exists
        ensureArrayTypesAnnotationTableExists();
    }

    /**
     * Ensure array_types_annotation_test table exists
     */
    private void ensureArrayTypesAnnotationTableExists() {
        try {
            jdbcTemplate.queryForObject("SELECT COUNT(*) FROM array_types_annotation_test WHERE 1=0", Integer.class);
        } catch (Exception e) {
            System.out.println("[ArrayTypesAnnotationTest] array_types_annotation_test table not found, creating...");
            try {
                String dialect = OneApiDataSourceManager.getDbDialect();
                if ("pg".equals(dialect)) {
                    jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS array_types_annotation_test (" +
                ...
                System.out.println("[ArrayTypesAnnotationTest] array_types_annotation_test table created successfully");
            } catch (Exception ex) {
                System.err.println("[ArrayTypesAnnotationTest] Failed to create table: " + ex.getMessage());
                throw new RuntimeException("Failed to create array_types_annotation_test table", ex);
            }
        }
    }
    ...
    public void testArrayJdbcType_ExplicitMapping() throws SQLException {
        ...
        // 查询
        ArrayTypesAnnotationModel loaded = lambdaTemplate.query(ArrayTypesAnnotationModel.class)
                .eq(ArrayTypesAnnotationModel::getId, 2)
                .queryForObject();
    ...
    public void testArrayTypeHandler_DirectSpecification() throws SQLException {
        ...
        // 查询
        ArrayTypesAnnotationModel loaded = lambdaTemplate.query(ArrayTypesAnnotationModel.class)
                .eq(ArrayTypesAnnotationModel::getId, 3)
                .queryForObject();
    ...
    public void testArrayNumberSpecial_JavaTypeMapping() throws SQLException {
        ...
        // 查询
        ArrayTypesAnnotationModel loaded = lambdaTemplate.query(ArrayTypesAnnotationModel.class)
                .eq(ArrayTypesAnnotationModel::getId, 4)
                .queryForObject();
    ...
    public void testArrayFullAnnotated_CompleteConfiguration() throws SQLException {
        ...
        // 查询
        ArrayTypesAnnotationModel loaded = lambdaTemplate.query(ArrayTypesAnnotationModel.class)
                .eq(ArrayTypesAnnotationModel::getId, 5)
                .queryForObject();
    ...
    public void testAllAnnotationScenarios_Together() throws SQLException {
        ...
        // 查询
        ArrayTypesAnnotationModel loaded = lambdaTemplate.query(ArrayTypesAnnotationModel.class)
                .eq(ArrayTypesAnnotationModel::getId, 100)
                .queryForObject();

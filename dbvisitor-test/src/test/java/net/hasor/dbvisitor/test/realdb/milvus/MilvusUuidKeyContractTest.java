...
import net.hasor.dbvisitor.test.contract.feature.keygen.UuidKeyContractTest;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;
import net.hasor.dbvisitor.test.nxn.env.MilvusProfile;
import org.junit.After;
import org.junit.Before;

public class MilvusUuidKeyContractTest extends UuidKeyContractTest {
    ...
    protected void ensureUuidStringTable() throws SQLException {
        this.fixture.userTable("user_uuid", "id VARCHAR(36) PRIMARY KEY");
    }

...
import net.hasor.dbvisitor.test.model.annotation.InsertExcludedUser;
import net.hasor.dbvisitor.test.model.annotation.ReadOnlyEmailUser;
import net.hasor.dbvisitor.test.model.annotation.UpdateExcludedUser;

...
import net.hasor.dbvisitor.test.contract.api.mapper.basemapper.BaseMapperCombinedCase;
...
public class MongoBaseMapperCombinedTest extends BaseMapperCombinedCase {
    ...
    protected String accessorInsertCommand() {
        return this.fixture.command("insert({id: ?, name: ?, age: ?, create_time: ?})");
    }

...
import net.hasor.dbvisitor.test.contract.api.lambda.LambdaPageOffsetContractTest;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;
import net.hasor.dbvisitor.test.nxn.env.MilvusProfile;
import org.junit.After;
import org.junit.Before;

public class MilvusLambdaPageOffsetContractTest extends LambdaPageOffsetContractTest {

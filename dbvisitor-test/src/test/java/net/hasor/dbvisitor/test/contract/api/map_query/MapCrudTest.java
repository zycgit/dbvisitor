...
public abstract class MapCrudTest extends AbstractNxnContractTest {
    ...
    public void mappedMapInsertPersistMapThroughEntityMap() throws SQLException {
        int id = baseId() + 1;
    ...
    public void mappedMapQueryPropertiesAsMapKeys() throws SQLException {
        int id = baseId() + 2;
    ...
    public void mappedMapUpdatePropertyNamesForCols() throws SQLException {
        int id = baseId() + 3;
    ...
    public void mappedMapDeleteRemoveByMappedPropertyCond() throws SQLException {
        int id = baseId() + 4;

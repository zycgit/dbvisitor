package net.hasor.dbvisitor.test.oneapi.suite.mapping.keygen;
...
import net.hasor.dbvisitor.test.oneapi.model.keygen.KeySequenceEmptyNameUser;
import net.hasor.dbvisitor.test.oneapi.model.keygen.KeySequenceNoAnnotationUser;
import net.hasor.dbvisitor.test.oneapi.model.keygen.KeySequenceUser;

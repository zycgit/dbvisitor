...
public class Elastic6XmlMapperResultMapTest extends XmlMapperResultMapCase {
    ...
    public void setup() throws SQLException {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            String name = "RmCfg" + i;
            int age = 25 + i;
            jdbcTemplate.executeUpdate("PUT /" + fixture.index() + "/_doc/" + id + " " + "{\"id\": ?,\"name\": ?,\"age\": ?,\"email\": ?,\"create_time\": ?," + "\"user_id\": ?,\"user_name\": ?,\"user_age\": ?}", new Object[] { id, name, age, "rmcfg" + i + "@nxn.test", new Date(), id, name, age });
        }
    }

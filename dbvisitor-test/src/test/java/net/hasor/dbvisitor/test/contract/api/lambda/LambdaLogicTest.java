...
@NxnContract
public abstract class LambdaLogicTest extends AbstractNxnContractTest {
    ...
    public void lambdaLogicNestedAndOrGroups() throws SQLException {
    ...
    public void lambdaLogicNestedGroupAfterOuterPred() throws SQLException {
    ...
    public void lambdaLogicNoArgAndAndNotMarkers() throws SQLException {
    ...
    public void lambdaLogicOrAndConsumerOnlyWhenEnabled() throws SQLException {
    ...
    public void lambdaLogicNotAndNestedConsumerOnlyWhenEnabled() throws SQLException {
    ...
    public void lambdaLogicNegateNestedCompCond() throws SQLException {
    ...
    public void lambdaLogicCombineNotInAndNotLikeGroups() throws SQLException {
    ...
    public void lambdaLogicCombineNotBtwnAndNullPreds() throws SQLException {
    ...
    public void lambdaLogicDoubleNotAsPositivePred() throws SQLException {
    ...
    public void lambdaLogicDisabledValuePreds() throws SQLException {
    ...
    public void lambdaLogicIfTrueConsumerOnlyWhenEnabled() throws SQLException {
    ...
    public void lambdaLogicComposeRawApplyCondsWithOtherPreds() throws SQLException {

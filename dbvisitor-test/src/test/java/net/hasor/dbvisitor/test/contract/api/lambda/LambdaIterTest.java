...
public abstract class LambdaIterTest extends AbstractNxnContractTest {
    ...
    public void lambdaIterForLimitLimitedRowsByBatch() throws SQLException {
    ...
    public void lambdaIterForLimitAllRowsWhenLimitIsNegative() throws SQLException {
    ...
    public void lambdaIterByBatchAllRowsUsingBatchSize() throws SQLException {
    ...
    public void lambdaIterQueryConds() throws SQLException {
        for (int i = 1; i <= 50; i++) {
    ...
    public void lambdaIterRows() throws SQLException {
    ...
    public void lambdaIterEmptyResults() throws SQLException {
        Iterator<UserInfo> iterator = lambdaTemplate.query(UserInfo.class)//
    ...
    public void lambdaIterConsumersToStopBeforeExhaustion() throws SQLException {
    ...
    public void lambdaIterTraverseLargeBatchResultSets() throws SQLException {

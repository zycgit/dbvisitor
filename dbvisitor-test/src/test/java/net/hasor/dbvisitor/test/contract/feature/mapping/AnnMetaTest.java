...
@NxnContract
public abstract class AnnMetaTest extends AbstractNxnContractTest {
    @Test
    @Capability(CapabilityId.MAPPING_ANNOTATION_TABLE_OPTIONS_METADATA)
    public void tableAnnCatalogSchemaDelimitedCaseAndCamelOptions() {
    ...
    public void tableAnnValueAndTableAttributesAsEquivalent() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void tableAnnAnnCatalogAndSchemaMeta() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void columnAnnOrderByColTemplates() {
        MappingRegistry registry = new MappingRegistry();

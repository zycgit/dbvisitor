...
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo1b;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo2;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo2Mapper;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo3;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo3Mapper;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo4Mapper;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo5;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo5Mapper;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo6;
import net.hasor.dbvisitor.test.realdb.elastic7.material.user.UserInfo6Mapper;
...
public class Elastic7MapperTest extends AdapterCase {
    @Override

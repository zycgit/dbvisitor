...
@NxnContract
public abstract class AnnMapperJoinQueryTest extends AbstractNxnContractTest {
    ...
    public void annotationJoinInnerJoinToDto() throws SQLException {
    ...
    public void annotationJoinInnerJoinToMap() throws SQLException {
    ...
    public void annotationJoinSqlAliasesToDtoProperties() throws SQLException {
    ...
    public void annotationJoinNullRightSideValuesForLeftJoin() throws SQLException {
    ...
    public void annotationJoinOneRowPerMatchingChild() throws SQLException {
        List<UserOrderDTO> results = this.mapper.selectUserOrderDTO(userId(1));
    ...
    public void annotationJoinAggregateJoinResult() throws SQLException {
        requiresNxnFeature(FeatureId.LEFT_JOIN_NULL_VALUES);
    ...
    public void annotationJoinMixedScalarTypesFromJoinedRows() throws SQLException {

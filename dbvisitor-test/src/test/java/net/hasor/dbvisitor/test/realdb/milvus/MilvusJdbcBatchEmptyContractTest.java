...
import net.hasor.dbvisitor.test.contract.api.jdbc.JdbcBatchEmptyContractTest;
...
public class MilvusJdbcBatchEmptyContractTest extends JdbcBatchEmptyContractTest {

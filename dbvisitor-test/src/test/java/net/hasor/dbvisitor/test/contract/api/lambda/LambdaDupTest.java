...
public abstract class LambdaDupTest extends AbstractNxnContractTest {
    ...
    public void duplicateStrategyIntoNewRowsAndRejectDupPrimaryKeys() throws SQLException {
    ...
    public void duplicateStrategyDefhaveLikeInto() throws SQLException {
        requiresNxnFeature(FeatureId.DUPLICATE_PRIMARY_KEY_REJECTED);
    ...
    public void duplicateStrategyIgnoreNewRowsAndKeepOriginalOnDup() throws SQLException {
    ...
    public void duplicateStrategyIgnoreRepeatedAndMixedDupRows() throws SQLException {
        requiresNxnFeature(FeatureId.DUPLICATE_KEY_STRATEGY);
    ...
    public void duplicateStrategyUpdateNewRowsAndUpdateDupRows() throws SQLException {
        requiresNxnFeature(FeatureId.DUPLICATE_KEY_STRATEGY);
        int newId = baseId() + 51;
    ...
    public void duplicateStrategyUpdateRepeatedMixedAndNullFieldUpdates() throws SQLException {
        requiresNxnFeature(FeatureId.DUPLICATE_KEY_STRATEGY);
    ...
    public void duplicateStrategyIgnoredRowUntilUpdateStrategyOverridesIt() throws SQLException {
        requiresNxnFeature(FeatureId.DUPLICATE_KEY_STRATEGY);
        int id = baseId() + 91;
        lambdaTemplate.insert(UserInfo.class)//

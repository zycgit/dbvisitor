...
public final class MySqlProfile extends AbstractDataSourceProfile {
    ...
    private static String[] features() {
        return new String[] { FeatureId.ARRAY, FeatureId.SEQUENCE, FeatureId.KNN, FeatureId.PROCEDURE_CURSOR_RESULT, FeatureId.XML_MAPPER_CALLABLE, FeatureId.FUNCTION_RECORD_RESULT, FeatureId.FUNCTION_TABLE_RESULT, FeatureId.VECTOR, FeatureId.XML_SELECT_KEY_USER_INFO_SEQUENCE, FeatureId.POSTGRES_ON_CONFLICT };
    }

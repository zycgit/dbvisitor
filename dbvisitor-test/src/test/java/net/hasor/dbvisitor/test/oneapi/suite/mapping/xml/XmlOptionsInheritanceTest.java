...
public class XmlOptionsInheritanceTest extends AbstractOneApiTest {
    ...
    public void testEntityOverridesRoot_CaseInsensitive() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_ci.xml"), "UTF-8");
    ...
    public void testEntityOverridesRoot_AutoMapping() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_am.xml"), "UTF-8");
    ...
    public void testGlobalOptions_CatalogSchemaInherited() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_global.xml"), "UTF-8");
    ...
    public void testGlobalOptions_EntityOverridesGlobal() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_override.xml"), "UTF-8");
    ...
    public void testResultMap_AutoMappingFalse() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_rm.xml"), "UTF-8");
    ...
    public void testResultMap_CaseInsensitive() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_rmci.xml"), "UTF-8");
    ...
    public void testAutoMapping_DefaultTrue() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/oneapi/mapping/opt_defaultam.xml"), "UTF-8");

...
public class XmlKeygenTest extends AbstractOneApiTest {
    ...
    private static final String XML_RESOURCE = "mapping/keygen_types.xml";
    ...
    public void testKeyType_Sequence_Metadata() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/mapping/keygen_sequence.xml"), "UTF-8");

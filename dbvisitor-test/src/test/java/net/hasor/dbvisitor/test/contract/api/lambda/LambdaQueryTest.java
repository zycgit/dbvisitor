...
@NxnContract
public abstract class LambdaQueryTest extends AbstractNxnContractTest {
    ...
    public void lambdaQueryCompareRangePreds() throws SQLException {
    ...
    public void lambdaQueryLikeStringPrefix() throws SQLException {
    ...
    public void lambdaQueryInExpandCollectionParam() throws SQLException {
    ...
    public void lambdaQueryNullNullAndNotNullCols() throws SQLException {
    ...
    public void lambdaQueryOrderRowsInRequestedOrder() throws SQLException {
    ...
    public void lambdaQueryPageAndOffsetResults() throws SQLException {
        for (int i = 1; i <= 12; i++) {
    ...
    public void lambdaQueryCountMatchingRowCount() throws SQLException {

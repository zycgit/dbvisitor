...
import net.hasor.dbvisitor.test.contract.api.mapper.annotation.AnnotationMapperConflictErrorCase;
...
public class MongoAnnotationMapperConflictErrorTest extends AnnotationMapperConflictErrorCase {
    ...
    public void setup() throws SQLException {
        ...
        this.fixture.uniqueIds();
    }

    @Override
    @Before
    public void createAnnotationMapper() throws Exception {
        this.mapper = this.fixture.session(newConfiguration()).createMapper(MongoCommandMapper.class);
    }

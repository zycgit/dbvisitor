...
public class MultipleResultSetTest extends AbstractOneApiTest {
    ...
    public void testMultipleExecute_ResultSetRule() throws SQLException {
        ...
        String multipleSql = "SELECT * FROM user_info WHERE age < 63; @{resultSet,name=youngUsers,javaType=net.hasor.dbvisitor.test.oneapi.model.UserInfo}\n" +//
                "SELECT * FROM user_info WHERE age >= 63; @{resultSet,name=seniorUsers,javaType=net.hasor.dbvisitor.test.oneapi.model.UserInfo}\n";

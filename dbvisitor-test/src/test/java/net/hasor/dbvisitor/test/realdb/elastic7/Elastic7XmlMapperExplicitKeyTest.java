...
public class Elastic7XmlMapperExplicitKeyTest extends XmlMapperExplicitKeyCase {
    ...
    @Override
    protected String mapperResource() { return "/mapper/elastic/ExplicitKeyMatrix.xml"; }
    @Override

...
public class MongoAnnotationMapperCommandExecutionTest extends AnnotationMapperCommandExecutionCase {
    ...
    protected void dropTableIfExists(String tableName) throws SQLException {
        this.jdbcTemplate.execute(this.fixture.source() + ".drop()");
    }

    @Override
    protected String createSimpleTempTableSql(String tableName) {
        return "db.createCollection('" + this.fixture.table() + "')";
    }

...
public abstract class XmlMetaTest extends AbstractNxnContractTest {
    ...
    public void xmlMapWritePolicyMeta() throws Exception {
    ...
    public void xmlMapCustomTypeHandlerClass() throws Exception {
    ...
    public void xmlMapExplicitJdbcTypes() throws Exception {
        MappingRegistry registry = load("mapping/type_handler_test.xml");
    ...
    public void xmlMapColDescriptionAttributes() throws Exception {
        MappingRegistry registry = load("mapping/type_handler_test.xml");
    ...
    public void xmlMapSqlTemplateAttributes() throws Exception {
    ...
    public void xmlMapEntityMetaFromXml() throws Exception {
    ...
    public void xmlMapResultMapMeta() throws Exception {
        MappingRegistry registry = load("mapping/basic_entity_mapper.xml");
    ...
    public void xmlMapLoadBoundaries() throws Exception {
    ...
    public void xmlMapOptionsInheritAndOverrides() throws Exception {
    ...
    public void xmlMapNamingOptions() throws Exception {
    ...
    public void xmlMapKeyGenerationMeta() throws Exception {
    ...
    public void xmlMapErrorPaths() throws Exception {
    ...
    public void xmlMapIndexSubElementsAndClassAnnFallback() throws Exception {

...
public class MongoXmlMapperStatementAttributeTest extends XmlMapperStatementAttributeCase {
    ...
    public void createXmlMapperSession() throws Exception {
        ...
        configuration.loadMapper("/realdb/mongo/StatementAttributeMapper.xml");

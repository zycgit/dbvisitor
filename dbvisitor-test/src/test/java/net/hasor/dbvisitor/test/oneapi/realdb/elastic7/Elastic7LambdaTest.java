...
import net.hasor.dbvisitor.test.oneapi.realdb.elastic7.dto_complex.Address;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic7.dto_complex.ComplexOrder;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic7.dto_complex.OrderItem;
import org.junit.After;
import org.junit.Before;
import org.junit.Test;

public class Elastic7LambdaTest {
    ...
    public void testGenericMapperCRUD() throws Exception {
        ...
        try (Session session = config.newSession(OneApiDataSourceManager.getConnection("es7"))) {

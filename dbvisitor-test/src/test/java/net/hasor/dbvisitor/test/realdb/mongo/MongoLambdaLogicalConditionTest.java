...
public class MongoLambdaLogicalConditionTest extends LambdaLogicalConditionCase {
    ...
    protected String rawAgePredicate(String operator, String value) {
        String mongoOperator = "le".equals(operator) ? "lte" : operator;
        return "{age: {$" + mongoOperator + ": " + value + "}}";
    }

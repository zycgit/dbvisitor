...
public abstract class AbstractJdbcQueryContractTest extends AbstractNxnContractTest {
    ...
    public void jdbcQueryForList_shouldReturnRowsAsMapsAndScalars() throws SQLException {
        seedUsers();
    ...
    public void jdbcQueryForObjectAndCount_shouldReturnScalarValues() throws SQLException {
        seedUsers();
    ...
    public void jdbcQueryForPairs_shouldReturnTypedKeyValueMaps() throws SQLException {
        seedUsers();

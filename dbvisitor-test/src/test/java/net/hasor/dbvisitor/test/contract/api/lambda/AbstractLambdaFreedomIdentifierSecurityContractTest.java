...
public abstract class AbstractLambdaFreedomIdentifierSecurityContractTest extends AbstractNxnContractTest {
    protected int baseId() {
        return 790000;
    }

    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_QUERY)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_SUBQUERY)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_ORDER_GROUP)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_SAMPLE_MAP)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_UPDATE)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_INSERT)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_TABLE)
    ...
    @Test
    @Capability(CapabilityId.LAMBDA_SECURITY_FREEDOM_IDENTIFIER_SELECT)

...
public final class NativeAnnotationMappingFixture implements AutoCloseable {
    ...
    public LambdaTemplate open(String environment) throws SQLException {
        ...
        // @formatter:off
        Class<?>[] models = { UserInfo.class, ColumnMappedUser.class, MethodColumnMappedUser.class, ColumnNameUser.class, ColumnValueUser.class,
    ...
    public void delete(int id) throws SQLException {
        String command = this.mongo ? "test." + this.collection + ".remove({id: ?})" : "POST /" + this.collection + "/_delete_by_query {\"query\": {\"term\": {\"id\": ?}}}";

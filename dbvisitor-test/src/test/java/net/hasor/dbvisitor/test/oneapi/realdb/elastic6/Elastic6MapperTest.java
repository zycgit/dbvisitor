...
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto1.UserInfo1BaseMapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto1.UserInfo1Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto1.UserInfo1a;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto1.UserInfo1b;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto2.UserInfo2;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto2.UserInfo2Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto3.UserInfo3;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto3.UserInfo3Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto3.UserInfo4Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto5.UserInfo5;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto5.UserInfo5Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto6.UserInfo6;
import net.hasor.dbvisitor.test.oneapi.realdb.elastic6.dto6.UserInfo6Mapper;
import org.junit.Test;

public class Elastic6MapperTest {
    @Test
    public void using_mapper_api_1() throws Exception {
        Configuration config = new Configuration();
        config.options().mapUnderscoreToCamelCase(true);

        try (Session s = config.newSession(OneApiDataSourceManager.getConnection("es6"))) {

...
public class Db2XmlMapperCallableContractTest extends XmlMapperCallableContractTest {
    @Override
    ...
    protected void createCallableDefinitions() throws SQLException {
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_insert_user(IN p_id INT, IN p_name VARCHAR(255)) " + //
                "LANGUAGE SQL BEGIN ATOMIC INSERT INTO user_info (id, name, age, create_time) VALUES (p_id, p_name, 0, " + currentTimestampExpression() + "); END");
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_multi_inout(IN p_prefix VARCHAR(255), IN p_suffix VARCHAR(255), INOUT p_concat VARCHAR(255), INOUT p_length INT) " + //
        ...
        jdbcTemplate.execute("CREATE PROCEDURE proc_user_stats(INOUT p_count INT, INOUT p_max_id INT, INOUT p_min_name VARCHAR(255)) " + //

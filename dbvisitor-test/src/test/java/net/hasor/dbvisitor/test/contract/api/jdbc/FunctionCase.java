...
@NxnContract
public abstract class FunctionCase extends AbstractNxnContractTest {
    @Before
    ...
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_SCALAR, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_NAMED_PARAMETER, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_OUT_RECORD, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_TABLE_RESULT, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_NULL_FALLBACK, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_CALL_CALLBACK, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.FUNCTION_QUERY_PARAMETER_VARIANTS, column = "jdbc/stored-routines/routines")

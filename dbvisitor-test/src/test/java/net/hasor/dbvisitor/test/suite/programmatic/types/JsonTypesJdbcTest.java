...
import net.hasor.dbvisitor.test.model.types.JsonAnnotatedBean;
import net.hasor.dbvisitor.test.model.types.JsonTestBean;
import net.hasor.dbvisitor.test.model.types.JsonTestBean.Address;
 ...
 * 数据库初始化：通过 /sql/{dialect}/init.sql 脚本自动创建 json_types_explicit_test 表

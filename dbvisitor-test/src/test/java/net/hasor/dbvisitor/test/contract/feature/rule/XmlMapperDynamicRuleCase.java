 ...
 */
package net.hasor.dbvisitor.test.contract.feature.rule;
...
@NxnContract
public abstract class XmlMapperDynamicRuleCase extends AbstractNxnContractTest {
    ...
    // 能力归属：参数传递与规则 / SQL 片段规则。
    @Test
    @Capability(value = CapabilityId.MAPPER_XML_DYNAMIC_RULE_AND, column = "parameters/command-rules/sql-fragments")
    ...
    // 能力归属：参数传递与规则 / SQL 片段规则。
    @Test
    @Capability(value = CapabilityId.MAPPER_XML_DYNAMIC_RULE_OR, column = "parameters/command-rules/sql-fragments")
    ...
    // 能力归属：参数传递与规则 / SQL 片段规则。
    @Test
    @Capability(value = CapabilityId.MAPPER_XML_DYNAMIC_RULE_IN, column = "parameters/command-rules/sql-fragments")
    ...
    // 能力归属：参数传递与规则 / SQL 片段规则。
    @Test
    @Capability(value = CapabilityId.MAPPER_XML_DYNAMIC_RULE_MIXED, column = "parameters/command-rules/sql-fragments")
    ...
    // 能力归属：参数传递与规则 / SQL 片段规则。
    @Test
    @Capability(value = CapabilityId.MAPPER_XML_DYNAMIC_RULE_MULTIPLE, column = "parameters/command-rules/sql-fragments")

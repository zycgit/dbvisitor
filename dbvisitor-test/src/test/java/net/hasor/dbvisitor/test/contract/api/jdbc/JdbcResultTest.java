...
@NxnContract
public abstract class JdbcResultTest extends AbstractNxnContractTest {
    ...
    public void rowMapperCustomMapAndDtoProjection() throws SQLException {
        seedUsers();
    ...
    public void rowMapperBuiltInMappers() throws SQLException {
        seedUsers();
    ...
    public void resultShortcutsMapListAndScalarValues() throws SQLException {
        seedUsers();
    ...
    public void rowCBHandlerStreamRows() throws SQLException {
        seedUsers();
    ...
    public void resultSetExtractorCustomAggregation() throws SQLException {
        seedUsers();
    ...
    public void resultSetExtractorBuiltInListExtractors() throws SQLException {
        seedUsers();
    ...
    public void resultSetExtractorPairsExtractor() throws SQLException {
        seedUsers();
    ...
    public void resultSetExtractorMapExtractors() throws SQLException {
        seedUsers();
    ...
    public void beanMapHonorIgnoredFields() throws SQLException {
        int id = baseId() + 31;

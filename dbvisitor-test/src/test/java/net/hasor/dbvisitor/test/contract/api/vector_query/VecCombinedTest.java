...
@NxnContract
public abstract class VecCombinedTest extends VectorQuerySupport {
    @Test
    @Capability(CapabilityId.VECTOR_RANGE_WITH_SCALAR_FILTER)
    public void knnComposeVectorRangeWithScalarPreds() throws SQLException {
    ...
    public void knnComposeVectorOrderingWithScalarPreds() throws SQLException {
        requiresNxnFeature(FeatureId.KNN);

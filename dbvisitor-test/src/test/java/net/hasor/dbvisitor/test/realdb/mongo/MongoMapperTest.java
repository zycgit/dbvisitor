...
import net.hasor.dbvisitor.test.realdb.mongo.dto1.UserInfo1Mapper;
import net.hasor.dbvisitor.test.realdb.mongo.dto2.UserInfo2;
import net.hasor.dbvisitor.test.realdb.mongo.dto2.UserInfo2Mapper;
import net.hasor.dbvisitor.test.realdb.mongo.dto3.UserInfo3;
import net.hasor.dbvisitor.test.realdb.mongo.dto3.UserInfo3Mapper;
import net.hasor.dbvisitor.test.realdb.mongo.dto3.UserInfo4Mapper;
import net.hasor.dbvisitor.test.realdb.mongo.dto5.UserInfo5;
import net.hasor.dbvisitor.test.realdb.mongo.dto5.UserInfo5Mapper;
import net.hasor.dbvisitor.test.realdb.mongo.dto6.UserInfo6;
import net.hasor.dbvisitor.test.realdb.mongo.dto6.UserInfo6Mapper;

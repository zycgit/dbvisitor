...
import net.hasor.dbvisitor.test.realdb.milvus.dto1.UserInfoMilvus1;
import net.hasor.dbvisitor.test.realdb.milvus.dto1.UserInfoMilvus1Mapper;
import net.hasor.dbvisitor.test.realdb.milvus.dto2.UserInfoMilvus2;
import net.hasor.dbvisitor.test.realdb.milvus.dto2.UserInfoMilvus2Mapper;
import net.hasor.dbvisitor.test.realdb.milvus.dto3.UserInfoMilvus3;
import net.hasor.dbvisitor.test.realdb.milvus.dto3.UserInfoMilvus3Mapper;
import net.hasor.dbvisitor.test.realdb.milvus.dto3.UserInfoMilvus4Mapper;
import net.hasor.dbvisitor.test.realdb.milvus.dto5.UserInfoMilvus5;
import net.hasor.dbvisitor.test.realdb.milvus.dto5.UserInfoMilvus5Mapper;
import net.hasor.dbvisitor.test.realdb.milvus.dto6.UserInfoMilvus6;
import net.hasor.dbvisitor.test.realdb.milvus.dto6.UserInfoMilvus6Mapper;

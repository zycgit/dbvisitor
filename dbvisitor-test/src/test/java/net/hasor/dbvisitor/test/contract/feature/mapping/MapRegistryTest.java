...
public abstract class MapRegistryTest extends AbstractNxnContractTest {
    @Test
    @Capability(CapabilityId.MAPPING_REGISTRY_OPTIONS_OBJECT)
    public void optionsDefsBuilderCopyFluentDialectAndToString() {
    ...
    public void optionsDrivePlainEntityMapAndAnnPrecedence() {
    ...
    public void mappingHelperTypeAliasesEnumsAndEntityDetection() throws Exception {
    ...
    public void mappingRegistryFindAndOverrideEntityMaps() {
    ...
    public void mappingRegistryTableColAndCollectionMeta() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void mappingRegistryInvalidArgumentsAndDupDefinitions() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void mappingRegistryMultiDefinitionsAndMissingLookups() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void mappingRegistryResultMapsFromAnnsAndOverrides() {
        MappingRegistry registry = new MappingRegistry();
    ...
    public void mappingRegistryConstructorDefsCacheAndSpaceIsolation() {

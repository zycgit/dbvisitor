...
public abstract class TableDefTest extends AbstractNxnContractTest {
    @Test
    @Capability(CapabilityId.MAPPING_TABLEDEF_DDL_AUTO_METADATA)
    public void tableDefinitionDdlAutoMeta() {
    ...
    public void tableDefinitionTableDescriptionAttributes() {
    ...
    public void tableDefinitionColDescriptionAttributes() {
    ...
    public void tableDefinitionIndexDescriptions() {
        TableMapping<?> mapping = mapping(FullDdlEntity.class);
    ...
    public void tableDefinitionInvalidIndexDescriptions() {
    ...
    public void tableDefinitionRegistryStructureBoundaries() throws Exception {

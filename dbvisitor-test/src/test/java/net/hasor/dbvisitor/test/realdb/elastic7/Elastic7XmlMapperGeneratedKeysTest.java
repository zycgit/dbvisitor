...
public class Elastic7XmlMapperGeneratedKeysTest extends XmlMapperGeneratedKeysCase {
    ...
    @Override
    protected String mapperResource() { return "/mapper/elastic/KeyGenerationMatrix.xml"; }
    @Override
    ...
    protected String readKeyName(Object id) throws Exception {
        return session.<String>queryStatement("xmltest.KeyGenerationMapper.selectById",

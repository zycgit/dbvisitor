...
public abstract class FreedomMapIdentifierSecurityCase extends AbstractNxnContractTest {
    ...
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_QUERY, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_SUBQUERY, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_ORDER_GROUP, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_SAMPLE_MAP, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_UPDATE, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_INSERT, column = "builder/map-query/modes")
    public void freedomIdentifier_shouldNotAllowInsertMapKeysToInjectColumnsOrValues() throws SQLException {
        ...
        if (loaded != null) {
            assertNotEquals("INSERT key payload must not inject name", "HACKED", loaded.getName());
            assertNotEquals("INSERT key payload must not inject age", Integer.valueOf(999), loaded.getAge());
        }
        assertTableReadable();
    }
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_TABLE, column = "builder/map-query/modes")
    ...
    // 能力归属：构造器 API / Map 查询模式。
    @Test
    @Capability(value = CapabilityId.MAP_QUERY_FREEDOM_IDENTIFIER_SELECT, column = "builder/map-query/modes")

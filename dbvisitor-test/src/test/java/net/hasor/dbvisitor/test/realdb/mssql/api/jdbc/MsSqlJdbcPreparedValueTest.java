...
public class MsSqlJdbcPreparedValueTest extends JdbcPreparedValueCase {
    @Override
    ...
    protected void createFixture() throws SQLException {
        try (Statement statement = this.connection.createStatement()) {
            statement.execute("CREATE TABLE " + this.table + " (id BIGINT PRIMARY KEY, name NVARCHAR(512))");
        }
    }

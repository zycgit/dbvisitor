...
@NxnContract
public abstract class VecKnnTest extends VectorQuerySupport {
    @Test
    @Capability(CapabilityId.VECTOR_KNN_ORDER_L2)
    public void knnByL2Distance() throws SQLException {
    ...
    public void knnByCosineAndInnerProductDistance() throws SQLException {
        requiresNxnFeature(FeatureId.KNN);
    ...
    public void knnMetricDrivenOrderingForMainPgVectorMetrics() throws SQLException {
        requiresNxnFeature(FeatureId.KNN);
    ...
    public void knnNearestNeighborResultsWithPageSize() throws SQLException {
        requiresNxnFeature(FeatureId.KNN);
    ...
    public void knnKnownL2CosineAndInnerProductOrdering() throws SQLException {
        requiresNxnFeature(FeatureId.KNN);
        int l2Id = baseId() + 360;

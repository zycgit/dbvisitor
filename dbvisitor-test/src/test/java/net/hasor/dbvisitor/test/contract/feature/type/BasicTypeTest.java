...
public abstract class BasicTypeTest extends AbstractNxnContractTest {
    ...
    public void basicNumericTypesThroughJdbcTemplate() throws SQLException {
        int id = baseId() + 1;
    ...
    public void basicBooleanTypesTrueFalseAndNull() throws SQLException {
        int trueId = baseId() + 2;
        int nullId = baseId() + 3;
    ...
    public void explicitBitAndBooleanTypesDBValues() throws SQLException {
    ...
    public void basicCharTypesAsciiUnicodeEmptyAndNull() throws SQLException {
        int id = baseId() + 6;

...
import net.hasor.dbvisitor.test.contract.api.mapper.annotation.AnnotationMapperCommandExecutionContractTest;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;
import net.hasor.dbvisitor.test.nxn.env.MilvusProfile;
import org.junit.After;
import org.junit.Before;

public class MilvusAnnotationMapperCommandExecutionContractTest extends AnnotationMapperCommandExecutionContractTest {
    ...
    protected String createSimpleTempTableSql(String tableName) {
        return this.fixture.executableSchema(tableName, "id INT64 PRIMARY KEY, name VARCHAR(128)");
    }

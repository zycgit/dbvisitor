...
@NxnContract
public abstract class ProcedureCase extends AbstractNxnContractTest {
    @Before
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_POSITIONAL_INOUT, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldBindPositionalInOutParameter() throws SQLException {
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_NAMED_INOUT, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldBindNamedInOutParameter() throws SQLException {
        requiresNxnFeature(FeatureId.PROCEDURE);
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_HASH_PARAMETER, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldBindHashStyleInOutParameter() throws SQLException {
        requiresNxnFeature(FeatureId.PROCEDURE);
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_MULTIPLE_INOUT, column = "jdbc/stored-routines/routines")
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_DATA_LOOKUP, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldReturnDataLookupThroughInOutParameters() throws SQLException {
        requiresNxnFeature(FeatureId.PROCEDURE);
        Map<String, Object> params = new HashMap<>();
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_HASH_METADATA, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldSupportHashParameterMetadataVariants() throws SQLException {
        requiresNxnFeature(FeatureId.PROCEDURE);
    ...
    // 能力归属：编程式 API / 存储过程与函数。
    @Test
    @Capability(value = CapabilityId.PROCEDURE_CALL_CURSOR_RESULT, column = "jdbc/stored-routines/routines")
    public void callProcedure_shouldMapCursorOutParameterToJavaTypeList() throws SQLException {
        requiresNxnFeature(FeatureId.PROCEDURE);

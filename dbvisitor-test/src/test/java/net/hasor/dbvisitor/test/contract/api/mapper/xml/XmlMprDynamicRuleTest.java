...
public abstract class XmlMprDynamicRuleTest extends AbstractNxnContractTest {
    ...
    public void dynamicRuleAndAppendCondsOnlyForPresentParams() throws Exception {
    ...
    public void dynamicRuleOrAppendUnionConds() throws Exception {
    ...
    public void dynamicRuleInExpandNestedInRuleInsideAndRule() throws Exception {
    ...
    public void dynamicRuleMixedComposeRuleSyntaxWithXmlTags() throws Exception {
    ...
    public void dynamicRuleMultiCombineSeveralAndRules() throws Exception {

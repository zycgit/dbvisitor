package net.hasor.dbvisitor.test.oneapi.realdb.mongo;
...
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto1.UserInfo1;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto1.UserInfo1BaseMapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto1.UserInfo1Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto2.UserInfo2;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto2.UserInfo2Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto3.UserInfo3;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto3.UserInfo3Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto3.UserInfo4Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto5.UserInfo5;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto5.UserInfo5Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto6.UserInfo6;
import net.hasor.dbvisitor.test.oneapi.realdb.mongo.dto6.UserInfo6Mapper;
...
public class MongoMapperTest {
    ...
    public void using_mapper_api_1() throws Exception {
        ...
        try (Session s = config.newSession(OneApiDataSourceManager.getConnection("mongo"))) {

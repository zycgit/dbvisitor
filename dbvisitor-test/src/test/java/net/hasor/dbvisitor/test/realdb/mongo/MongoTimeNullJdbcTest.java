...
import net.hasor.dbvisitor.test.contract.feature.type.TimeNullJdbcCase;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;
import net.hasor.dbvisitor.test.nxn.env.MongoProfile;
import org.junit.After;
import org.junit.Before;

public class MongoTimeNullJdbcTest extends TimeNullJdbcCase {
    ...
    public void setup() throws SQLException {
        this.jdbcTemplate = this.fixture.open(profile().env(), "time_types_explicit_test");
    }

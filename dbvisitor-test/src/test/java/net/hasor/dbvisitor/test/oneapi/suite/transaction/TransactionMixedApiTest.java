package net.hasor.dbvisitor.test.oneapi.suite.transaction;
...
public class TransactionMixedApiTest extends AbstractOneApiTest {
    ...
    public void testMixed_SessionAndLambda_Commit() throws Exception {
        ...
        config.loadMapper("/oneapi/mapper/StatementTestMapper.xml");
        ...
        session.executeStatement("oneapi.StatementTestMapper.insertUserWithId", params);
        ...
        q.put("id", 63011);
        List<UserInfo> sessionResult = session.queryStatement("oneapi.StatementTestMapper.queryUserById", q);

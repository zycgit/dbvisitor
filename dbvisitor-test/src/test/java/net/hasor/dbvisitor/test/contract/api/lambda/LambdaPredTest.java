...
@NxnContract
public abstract class LambdaPredTest extends AbstractNxnContractTest {
    ...
    public void lambdaPredHonorDynamicComparisonFlags() throws SQLException {
    ...
    public void lambdaPredCombineComparisonOperators() throws SQLException {
    ...
    public void lambdaPredAllRangeEdgeVariants() throws SQLException {
    ...
    public void lambdaPredNotRangeVariants() throws SQLException {
    ...
    public void lambdaPredHonorDynamicRangeFlags() throws SQLException {
    ...
    public void lambdaPredSingleAndLargeInCollections() throws SQLException {
    ...
    public void lambdaPredSqlNotInNullSemantic() throws SQLException {
    ...
    public void lambdaPredLikeLeftRightAndContains() throws SQLException {
    ...
    public void lambdaPredNotLikeLeftRightAndContains() throws SQLException {
    ...
    public void lambdaPredLikeNullsAndMultiLikePreds() throws SQLException {
    ...
    public void lambdaPredStringPropertyComparisonOperators() throws SQLException {
    ...
    public void lambdaPredHonorStringPropertyDynamicFlags() throws SQLException {
    ...
    public void lambdaPredStringPropertyLikeVariants() throws SQLException {
    ...
    public void lambdaPredStringPropertyCollectionNullRangeAndSampleMap() throws SQLException {

...
@NxnContract
public abstract class JdbcMultiRSTest extends AbstractNxnContractTest {
    ...
    public void jdbcMultiExecuteMultiResultSets() throws SQLException {
    ...
    public void jdbcMultiExecutePosParamsAcrossStmts() throws SQLException {
        requiresNxnFeature(FeatureId.MULTIPLE_RESULT_SETS);
        seedUsers();
    ...
    public void jdbcMultiExecuteNamedParamsAcrossStmts() throws SQLException {
        requiresNxnFeature(FeatureId.MULTIPLE_RESULT_SETS);
        seedUsers();
    ...
    public void jdbcMultiExecuteNameAndMapResultSetsWithRule() throws SQLException {
        requiresNxnFeature(FeatureId.MULTIPLE_RESULT_SETS);
        seedUsers();

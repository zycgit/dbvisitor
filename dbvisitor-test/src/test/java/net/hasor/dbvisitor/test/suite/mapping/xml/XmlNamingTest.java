...
public class XmlNamingTest extends AbstractOneApiTest {
    ...
    private static final String XML_RESOURCE = "mapping/naming_options.xml";
    ...
    public void testCamelCase_RootLevelInherited() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/mapping/naming_root_cc.xml"), "UTF-8");
    ...
    public void testCamelCase_EntityOverridesRoot() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/mapping/naming_override.xml"), "UTF-8");
    ...
    public void testCamelCase_DefaultFalse() throws Exception {
        String xml = IOUtils.readToString(getClass().getResourceAsStream("/mapping/naming_default.xml"), "UTF-8");

...
import net.hasor.dbvisitor.test.oneapi.model.AnnotatedEntity;
import net.hasor.dbvisitor.test.oneapi.model.ExplicitAnnotatedEntity;
import net.hasor.dbvisitor.test.oneapi.model.PlainEntity;

...
import net.hasor.dbvisitor.test.contract.api.mapper.basemapper.BaseMapperDefaultKeyContractTest;
import net.hasor.dbvisitor.test.nxn.env.DataSourceProfile;
import net.hasor.dbvisitor.test.nxn.env.MilvusProfile;

public class MilvusBaseMapperDefaultKeyContractTest extends BaseMapperDefaultKeyContractTest {
    private final MilvusUserInfoFixture fixture = new MilvusUserInfoFixture(true);

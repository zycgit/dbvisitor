...
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto1.UserInfo1Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto2.UserInfo2;
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto2.UserInfo2Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto3.UserInfo3;
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto3.UserInfo3Mapper;
import net.hasor.dbvisitor.test.oneapi.realdb.redis.dto3.UserInfo4Mapper;

...
@NxnContract
public abstract class FreeMapSecureTest extends AbstractNxnContractTest {
    ...
    public void freedomIdNotExpandQueryWhenColNameContainsPayload() throws SQLException {
    ...
    public void freedomIdSubqueryAsColId() throws SQLException {
    ...
    public void freedomIdOrderAndGroupPayloadsNonDestructive() throws SQLException {
    ...
    public void freedomIdNotTrustEqBySampleMapKeys() throws SQLException {
    ...
    public void freedomIdNotAllowUpdateColPayloadsToChangeExtraData() throws SQLException {
    ...
    public void freedomIdNotAllowInsertMapKeysToInjectColsOrValues() throws SQLException {
        Map<String, Object> maliciousMap = new LinkedHashMap<>();
    ...
    public void freedomIdNotAllowTableNamePayloadsToUnionRows() throws SQLException {
    ...
    public void freedomIdNotAllowSelectColPayloadsToLeakCalculatedAliases() throws SQLException {

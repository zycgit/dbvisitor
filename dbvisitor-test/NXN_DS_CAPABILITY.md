...
| **参数绑定与结果处理能力** | | | | | | | | | | | | | |
| &emsp;JDBC 值绑定安全、复用、NULL/空串、写入过滤和 fetchSize/maxRows | `JdbcPreparedValueContractTest(7条)` | ✅ | — | — | — | — | — | — | — | — | — | — | ✅ |
...
| &emsp;列表与标量查询返回（注解 Mapper） | `AnnotationMapperQueryResultContractTest(1条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | — | ✅ |
...
| &emsp;计算投影的标量与 Map 映射（注解 Mapper） | `AnnotationMapperProjectionResultContractTest(2条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | — | ❌ |
| &emsp;PageObject 列表分页（注解 Mapper） | `AnnotationMapperPaginationResultContractTest(1条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | — | ✅ |
| &emsp;resultMap 配置与结果映射（XML Mapper） | `XmlMapperResultMapContractTest(8条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | — | ✅ |
...
| &emsp;生成键回填与键来源（注解 Mapper） | `AnnotationMapperGeneratedKeysContractTest(3条)` | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3 | ✅ | ✅ | ❌ | — | — | — | — | ⚠️ 1/3 |
| &emsp;selectKey 执行（注解 Mapper） | `AnnotationMapperSelectKeyContractTest(1条)` | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | — | — | — | — | ❌ |
| &emsp;边界测试（注解 Mapper） | `AnnotationMapperEdgeContractTest(6条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ 4/6 | — | — | — | — | ⚠️ 4/6 |
| &emsp;生成键回填与键来源（XML Mapper） | `XmlMapperGeneratedKeysContractTest(4条)` | ⚠️ 3/4 | ⚠️ 3/4 | ⚠️ 3/4 | ⚠️ 3/4 | ✅ | ✅ | ❌ | — | — | — | — | ⚠️ 2/4 |
...
| &emsp;动态模板分支、参数展开与更新字段（XML Mapper） | `XmlMapperDynamicSqlContractTest(8条)` | ✅ | ✅ | ✅ | ⚠️ 7/8 | ✅ | ✅ | ✅ | — | — | — | — | ✅ |
...
| **值、边界与安全能力** | | | | | | | | | | | | | |
| &emsp;边界条件（空表/null/极值）（Lambda） | `LambdaEdgeContractTest(9条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ 5/9 | — | — | — | — | ⚠️ 7/9 |
...
| &emsp;二进制类型（TypeHandler） | `BinaryTypeJdbcContractTest(4条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ 1/4 | — | — | — | — | ❌ |
...
| &emsp;时间精度、日历与极值边界（TypeHandler） | `TimeBoundaryJdbcContractTest(3条)` | ⚠️ 2/3 | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ 2/3 | — | — | — | — | ✅ |
...
| &emsp;数组类型（TypeHandler） | `ArrayTypeJdbcContractTest(7条)` | ✅ | ⚠️ 1/7 | ✅ | ⚠️ 1/7 | ⚠️ 1/7 | ⚠️ 1/7 | ⚠️ 1/7 | — | — | — | — | ✅ |
...
| &emsp;函数调用（过程/函数） | `FunctionContractTest(7条)` | ⚠️ 6/7 | ⚠️ 4/7 | ✅ | ✅ | ✅ | ✅ | ⚠️ 3/7 | — | — | — | — | ❌ |
| **Session 生命周期能力** | | | | | | | | | | | | | |
| &emsp;Session 生命周期（Session） | `SessionCoreContractTest(11条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | — | ⚠️ 10/11 |
...
| oracle | 704 | 654 | 50 | 0 |
| db2 | 704 | 664 | 40 | 0 |
| clickhouse | 705 | 571 | 134 | 0 |
| redis | 75 | 74 | 0 | 1 |
| mongo | 135 | 111 | 0 | 24 |
| es6 | 184 | 146 | 0 | 38 |
| es7 | 192 | 154 | 0 | 38 |
| milvus | 884 | 712 | 163 | 9 |
| 合计 | 6407 | 5790 | 507 | 110 |
...
12 个数据源的能力声明、契约绑定、注解及报告生成另有 48 项本地检查，全部通过，不计入上表。

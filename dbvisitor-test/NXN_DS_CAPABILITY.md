...
| &emsp;JDBC 值绑定安全、复用、NULL/空串、写入过滤和 fetchSize/maxRows | `JdbcPreparedValueCase(7条)` | ✅ | ✅ | ✅ | ⚠️ 6/7 | ✅ | ✅ | ✅ | ⚠️ 6/7 | ✅ | ✅ | ✅ | ✅ |
| &emsp;存储过程（过程/函数） | `ProcedureCase(7条)` | ❌ | ⚠️ 6/7 | ✅ | ✅ | ⚠️ 6/7 | ⚠️ 6/7 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| &emsp;call 的原生命令结果集收集（JdbcTemplate） | `JdbcCallResultCase(1条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |
| &emsp;函数调用（过程/函数） | `FunctionCase(7条)` | ✅ | ⚠️ 4/7 | ✅ | ✅ | ✅ | ✅ | ⚠️ 4/7 | ⚠️ 4/7 | ⚠️ 3/7 | ⚠️ 3/7 | ⚠️ 3/7 | ❌ |
| **5.2 Mapper API** | | | | | | | | | | | | | |
...
| &emsp;生成键回填与键来源（注解 Mapper） | `AnnotationMapperGeneratedKeysCase(3条)` | ✅ | ⚠️ 2/3 | ✅ | ⚠️ 2/3 | ✅ | ✅ | ❌ | ⚠️ 1/3 | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3 |
...
| &emsp;标准物料的 JDBC 表/列元数据（Schema） | `StandardSchemaCase(2条)` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ⚠️ 1/2 | ✅ | ✅ | ✅ |
| **6. 参数传递** | | | | | | | | | | | | | |
...
| --- | --- | ---: | ---: | ---: | ---: |
| h2 | 2026-09-13 | 715 | 683 | 32 | 0 |
| mysql | 2026-09-13 | 717 | 687 | 30 | 0 |
| pg | 2026-09-13 | 718 | 718 | 0 | 0 |
| oracle | 2026-09-13 | 720 | 687 | 33 | 0 |
| mssql | 2026-09-13 | 721 | 694 | 27 | 0 |
| db2 | 2026-09-13 | 718 | 690 | 28 | 0 |
| clickhouse | 2026-09-13 | 728 | 635 | 93 | 0 |
| redis | 2026-09-13 | 335 | 299 | 36 | 0 |
| mongo | 2026-09-13 | 617 | 605 | 12 | 0 |
| es6 | 2026-09-13 | 662 | 647 | 15 | 0 |
| es7 | 2026-09-13 | 684 | 668 | 16 | 0 |
| milvus | 2026-09-13 | 897 | 743 | 154 | 0 |
| 合计 | 2026-09-13 | 8232 | 7756 | 476 | 0 |

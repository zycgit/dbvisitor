...
> ✅ 对应场景全部通过；❌ 对应场景受数据库、驱动或 dbVisitor 的能力限制；⚠️ x/y 表示 y 个场景中有 x 个通过，其余受限。执行失败、缺少测试或尚未验证不能作为“不支持”的依据。执行范围和验证基线见 §3。
>
> 本表关注 dbVisitor 整合能力。SQL、Redis 命令、Mongo DSL、ES 请求等均视为原生命令；使用原生命令完成 CRUD 同样计入 CRUD 覆盖，不要求命令采用 SQL 语法。Milvus 适配器的 SQL 与 SDK 对应关系见 [Milvus 语法文档](../dbvisitor-doc/docs/features/milvus/about.md)。
...
| &emsp;Bean 与 Map 的列名大小写匹配                                      | `JdbcColumnMappingCase(3条)`                                       | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;JDBC 值绑定安全、复用、NULL/空串、写入过滤和 fetchSize/maxRows    | `JdbcPreparedValueCase(7条)`                                       | ✅    | ✅     | ✅ | ⚠️6/7    | ✅     | ✅     | ✅     | ⚠️ 6/7  | ✅     | ✅     | ✅     | ✅      |
| &emsp;存储过程（过程/函数）                                             | `ProcedureCase(7条)`                                               | ❌    | ⚠️6/7  | ✅ | ✅       | ⚠️6/7 | ⚠️6/7  | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;call 的原生命令结果集收集（JdbcTemplate）                         | `JdbcCallResultCase(1条)`                                          | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ❌     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;函数调用（过程/函数）                                             | `FunctionCase(7条)`                                                | ✅    | ⚠️4/7  | ✅ | ✅       | ✅     | ✅     | ⚠️4/7  | ⚠️4/7   | ⚠️ 3/7 | ⚠️ 3/7 | ⚠️ 3/7 | ❌      |
| **5.2 Mapper API**                                                      |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
| &emsp;实体与列表插入（BaseMapper）                                      | `BaseMapperInsertCase(4条)`                                        | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;写入限制与错误传递（BaseMapper）                                  | `BaseMapperWriteValidationCase(3条)`                               | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ✅     | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 1/3  |
...
| &emsp;实体类型、Session 与 Jdbc 访问器（BaseMapper）                    | `BaseMapperAccessorsCase(1条)`                                     | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;原生命令的对象列表与标量返回（注解 Mapper）                       | `AnnotationMapperQueryResultCase(1条)`                             | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;默认映射、自定义处理器与空结果（注解 Mapper）                     | `AnnotationMapperResultHandlerCase(7条)`                           | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;计算投影的标量与 Map 映射（注解 Mapper）                          | `AnnotationMapperProjectionResultCase(2条)`                        | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ❌      |
...
| &emsp;执行方式、超时与取数配置（注解 Mapper）                           | `AnnotationMapperExecutionCase(5条)`                               | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;结果集类型配置（注解 Mapper）                                     | `AnnotationMapperResultSetTypeCase(1条)`                           | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;可滚动结果集类型配置（注解 Mapper）                               | `AnnotationMapperScrollableTypeCase(2条)`                          | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;生成键回填与键来源（注解 Mapper）                                 | `AnnotationMapperGeneratedKeysCase(3条)`                           | ✅    | ⚠️2/3  | ✅ | ⚠️ 2/3   | ✅     | ✅     | ❌     | ⚠️ 1/3  | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3  |
...
| &emsp;原生命令的解析与执行错误传播（注解 Mapper）                       | `AnnotationMapperCommandErrorCase(1条)`                            | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;Mapper 注册、代理创建与非法接口校验（Session）                    | `SessionMapperRegistrationCase(3条)`                               | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;Mapper 方法调用与列表/标量返回（Session）                         | `SessionMapperInvocationCase(2条)`                                 | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;BaseMapper 与其他 Mapper、JdbcTemplate 数据共享（Session）        | `SessionMapperSharingCase(2条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;方法注解、Mapper 文件与 JdbcTemplate 数据共享（Session）          | `SessionNativeSharingCase(2条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;Session 生命周期（Session）                                       | `SessionCoreCase(10条)`                                            | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ⚠️ 5/10 | ✅     | ✅     | ✅     | ✅      |
| &emsp;Configuration 创建 Jdbc 与 Session                                | `SessionFactoryCase(1条)`                                          | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| **5.3 构造器 API**                                                      |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
| &emsp;基本 CRUD（Lambda）                                               | `LambdaCrudCase(4条)`                                              | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;Lambda 写入后的 JdbcTemplate 标量与计数回读（组合场景）           | `LambdaJdbcReadbackCase(3条)`                                      | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;排序（ASC/DESC/null 排序）（Lambda）                              | `LambdaSortCase(4条)`                                              | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ❌      |
| &emsp;页偏移、翻页与无重复遍历（Lambda）                                | `LambdaPageNavigationCase(3条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;分页读取与总条数、总页数一致性（Lambda）                          | `LambdaPageResultCase(9条)`                                        | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;边界条件（空表/null/极值）（Lambda）                              | `LambdaEdgeCase(8条)`                                              | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ⚠️ 6/8 | ❌      | ✅     | ✅     | ✅     | ⚠️ 6/8  |
| &emsp;安全值（注入防护）（Lambda）                                      | `LambdaSecurityValueCase(10条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ⚠️ 8/10 |
| &emsp;特殊值（超长字符串/特殊字符）（Lambda）                           | `LambdaSpecialValueCase(9条)`                                      | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ⚠️ 8/9 | ❌      | ✅     | ⚠️ 8/9 | ⚠️ 8/9 | ⚠️ 8/9  |
| **5.4 Mapper 文件**                                                     |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
...
| &emsp;结果处理（XML Mapper）                                            | `XmlMapperResultHandlerCase(4条)`                                  | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;生成键回填与键来源（XML Mapper）                                  | `XmlMapperGeneratedKeysCase(4条)`                                  | ✅    | ⚠️ 3/4 | ✅ | ⚠️ 3/4   | ✅     | ✅     | ❌     | ⚠️ 1/4  | ⚠️ 3/4 | ⚠️ 3/4 | ⚠️ 3/4 | ⚠️ 3/4  |
| &emsp;selectKey 前置与后置执行（XML Mapper）                            | `XmlMapperSelectKeyCase(2条)`                                      | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ❌      |
| &emsp;命令片段组合（`<sql>` / `<include>`）（XML Mapper）               | `XmlMapperSqlFragmentCase(4条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;动态模板分支、参数展开与更新字段（XML Mapper）                    | `XmlMapperDynamicSqlCase(8条)`                                     | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ⚠️ 5/8  | ✅     | ✅     | ✅     | ✅      |
| &emsp;动态规则引擎（XML Mapper）                                        | `XmlMapperDynamicRuleCase(5条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ❌     | ❌     | ❌     | ✅      |
| &emsp;statement 类型、超时、fetchSize 与前向结果集（XML Mapper）        | `XmlMapperStatementAttributeCase(5条)`                             | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;可滚动结果集选项（XML Mapper）                                    | `XmlMapperScrollableResultCase(1条)`                               | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;外部 XML 引用与 CRUD（RefMapper）                                 | `XmlRefMapperCrudCase(1条)`                                        | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;动态条件、集合展开与文本替换（RefMapper）                         | `XmlRefMapperTemplateCase(3条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ⚠️ 2/3  | ✅     | ✅     | ✅     | ✅      |
| &emsp;Map 与 Bean 入参（RefMapper）                                     | `XmlRefMapperParameterCase(1条)`                                   | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;多行 Map 结果映射（RefMapper）                                    | `XmlRefMapperResultMapCase(1条)`                                   | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;存储过程调用（XML Mapper）                                        | `XmlMapperCallableCase(6条)`                                       | ❌    | ⚠️ 5/6 | ✅ | ✅       | ⚠️ 5/6 | ⚠️ 5/6 | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
| **5.5 Map 查询模式**                                                    |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
...
| &emsp;NULL 字段插入与显式更新（对象映射）                               | `AnnotationNullFieldMappingCase(2条)`                              | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;手工主键与完整性校验（主键）                                      | `AssignedKeyCase(3条)`                                             | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ⚠️ 1/3 | ❌      | ✅     | ⚠️ 2/3 | ⚠️ 2/3 | ⚠️ 2/3  |
| &emsp;数据库生成主键回填（主键）                                        | `DatabaseGeneratedKeyCase(4条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ❌     | ❌     | ❌     | ⚠️ 3/4  |
| &emsp;客户端 UUID 生成（主键）                                          | `UuidKeyCase(4条)`                                                 | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;自定义主键处理器（主键）                                          | `CustomKeyHolderCase(7条)`                                         | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ⚠️ 6/7 | ❌      | ✅     | ⚠️ 6/7 | ⚠️ 6/7 | ✅      |
| &emsp;序列键配置与执行（主键）                                          | `SequenceKeyCase(2条)`                                             | ✅    | ❌     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;字段命名转换与注解覆盖（对象映射）                                | `NamingConversionCase(9条)`                                        | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;结果列名大小写匹配（对象映射）                                    | `ResultColumnCasingCase(3条)`                                      | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;大小写敏感标识符（Schema）                                        | `IdentifierCasingCase(4条)`                                        | ✅    | ✅     | ✅ | ✅       | ❌     | ✅     | ✅     | ❌      | ✅     | ⚠️ 3/4 | ⚠️ 3/4 | ✅      |
| &emsp;分隔符与关键字引用（Schema）                                      | `IdentifierQuotingCase(6条)`                                       | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ❌      |
| **6. 参数传递**                                                         |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
...
| &emsp;按字段名读取 Date（TypeHandler，原生命令）                        | `NativeNamedFieldTypeCase.date_shouldRoundTripByFieldName(1条)`    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;按字段名读取枚举名称（TypeHandler，原生命令）                     | `NativeNamedFieldTypeCase.enum_shouldRoundTripByFieldName(1条)`    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;按字段名读取 true/false（TypeHandler，原生命令）                  | `NativeNamedFieldTypeCase.boolean_shouldRoundTripByFieldName(1条)` | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;整型与浮点数往返（TypeHandler）                                   | `BasicNumericTypeJdbcCase(1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;高精度小数往返（TypeHandler）                                     | `BasicDecimalTypeJdbcCase(1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;大整数往返（TypeHandler）                                         | `BasicBigIntegerTypeJdbcCase(1条)`                                 | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;布尔值往返（TypeHandler）                                         | `BasicBooleanTypeJdbcCase(1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;布尔空值绑定与读取（TypeHandler）                                 | `BasicBooleanNullJdbcCase(1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;ASCII 与 Unicode 字符往返（TypeHandler）                          | `BasicCharacterTypeJdbcCase(1条)`                                  | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;字符空值绑定与读取（TypeHandler）                                 | `BasicCharacterNullJdbcCase(1条)`                                  | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;空字符串往返（TypeHandler）                                       | `BasicEmptyStringJdbcCase(1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;枚举类型映射（TypeHandler）                                       | `EnumTypeJdbcCase(5条)`                                            | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ⚠️4/5   | ✅     | ✅     | ✅     | ✅      |
| &emsp;二进制类型（TypeHandler）                                         | `BinaryTypeJdbcCase(4条)`                                          | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ⚠️3/4   | ✅     | ✅     | ✅     | ❌      |
...
| &emsp;时间精度、日历与极值边界（TypeHandler）                           | `TimeBoundaryJdbcCase(3条)`                                        | ⚠️2/3 | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
...
| &emsp;传播与跨代理调用（事务）                                          | `TransactionPropagationCase(15条)`                                 | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;无现有事务时的 SUPPORTS / NEVER 传播                              | `NonTransactionPropagationCase(2条)`                               | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;嵌套事务与保存点（事务）                                          | `TransactionNestedCase(6条)`                                       | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
...
| **JDBC 元信息**                                                         |                                                                    |       |        |    |          |        |        |        |         |        |        |        |         |
| &emsp;库名称与当前库（Catalog）                                         | `JdbcCatalogCase(1条)`                                             | ✅    | ✅     | ✅ | ❌       | ✅     | ❌     | ✅     | ✅      | ✅     | ❌     | ❌     | ✅      |
| &emsp;Schema 名称与当前 Schema                                          | `JdbcSchemaCase(1条)`                                              | ✅    | ❌     | ✅ | ✅       | ✅     | ✅     | ❌     | ❌      | ❌     | ❌     | ❌     | ❌      |
| &emsp;表类型列表                                                        | `JdbcTableTypeCase(1条)`                                           | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;空结果列结构与不存在的命名层级                                    | `JdbcMetadataShapeCase(1条)`                                       | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ✅      | ✅     | ✅     | ✅     | ✅      |
| &emsp;标准物料的表信息                                                  | `StandardSchemaCase(表，1条)`                                      | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ✅     | ✅     | ✅     | ✅      |
| &emsp;标准物料的字段信息                                                | `StandardSchemaCase(字段，1条)`                                    | ✅    | ✅     | ✅ | ✅       | ✅     | ✅     | ✅     | ❌      | ❌     | ✅     | ✅     | ✅      |
...
|------------|----------------|-------:|-----:|-----:|----------:|
| h2         | 2026-09-14     |    719 |  687 |   32 |         0 |
| mysql      | 2026-09-14     |    721 |  690 |   31 |         0 |
| pg         | 2026-09-14     |    722 |  722 |    0 |         0 |
| oracle     | 2026-09-14     |    724 |  690 |   34 |         0 |
| mssql      | 2026-09-14     |    725 |  698 |   27 |         0 |
| db2        | 2026-09-14     |    722 |  693 |   29 |         0 |
| clickhouse | 2026-09-14     |    732 |  638 |   94 |         0 |
| redis      | 2026-09-14     |    339 |  301 |   38 |         0 |
| mongo      | 2026-09-14     |    621 |  608 |   13 |         0 |
| es6        | 2026-09-14     |    666 |  649 |   17 |         0 |
| es7        | 2026-09-14     |    688 |  670 |   18 |         0 |
| milvus     | 2026-09-14     |    901 |  746 |  155 |         0 |
| 合计       | 2026-09-13～14 |   8280 | 7792 |  488 |         0 |

统计采用完整 realdb 集合及受影响测试类的最新复验结果，不重复计数。用例数包含原生命令执行与本地映射检查，不是实际执行的命令数量。跳过项对应明确的能力限制，不能推断所属 API 整体不支持。Milvus 的 6 项明文、TLS/mTLS 正反向连接检查均通过；反向用例先验证正确证书可连接，避免将端口不可达误判为证书校验成功。
...
./gradlew :dbvisitor-test:test -Pnxn.env=redis --tests '*api.jdbc.metadata.*Test'
```

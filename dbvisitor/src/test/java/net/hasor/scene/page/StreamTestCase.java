...
//            Iterator<UserInfo2> userIterator = lambdaTemplate.queryByEntity(UserInfo2.class).iteratorForLimit(-1, 1);
...
//            //
//            List<String> userIds = new ArrayList<>();
//            Iterator<UserInfo2> userIterator = lambdaTemplate.queryByEntity(UserInfo2.class).iteratorForLimit(2, 1);
//            while (userIterator.hasNext()) {
//                userIds.add(userIterator.next().getUid());
//            }
//

...
public class RowMapperTestCase {
    ...
    public void noArgsExtractor_0() throws SQLException {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<String> result = jdbcTemplate.queryForList("select * from user where age > ? order by id", args, rowMapper);
    ...
    public void arrayArgsRowMapper_0() throws SQLException {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            UserNameRowMapper rowMapper = new UserNameRowMapper();
            List<String> result = jdbcTemplate.queryForList("select * from user where age > 40 order by id", rowMapper);
    ...
    public void mapArgsRowMapper_0() throws SQLException {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<String> result = jdbcTemplate.queryForList("select * from user where age > :age order by id", args, rowMapper);
    ...
    public void setterArgsRowMapper_0() throws SQLException {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<String> result = jdbcTemplate.queryForList("select * from user where age > ? order by id", setter, rowMapper);
    ...
    public void sourceArgsRowMapper_0() throws SQLException {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<String> result = jdbcTemplate.queryForList("select * from user where age > :arg order by id", argSource, rowMapper);

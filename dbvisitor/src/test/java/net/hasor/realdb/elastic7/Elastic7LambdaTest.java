...
import net.hasor.realdb.elastic7.dto_complex.Address;
import net.hasor.realdb.elastic7.dto_complex.ComplexOrder;
import net.hasor.realdb.elastic7.dto_complex.OrderItem;
...
public class Elastic7LambdaTest extends AbstractDbTest {

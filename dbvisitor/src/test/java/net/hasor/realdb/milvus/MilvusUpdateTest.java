...
public class MilvusUpdateTest extends AbstractDbTest {
    ...
    public void testUpdateColumns() throws SQLException {
        try (Connection c = createConnection()) {
            ...
            int r1 = lambda.update(UserInfoMilvus.class)
                    .eq(UserInfoMilvus::getUid, "u_001")
                    .updateTo(UserInfoMilvus::getName, "name_updated")
                    .doUpdate();
            assert r1 == 1;
            ThreadUtils.sleep(1000);
            ...
            assert "login_init".equals(u1.getLoginName()); // Should verify other fields unchanged (if implementation supports partial update properly)

            // 3. Update Multiple Columns
            int r2 = lambda.update(UserInfoMilvus.class)
                    .eq(UserInfoMilvus::getUid, "u_001")
                    .updateTo(UserInfoMilvus::getName, "name_updated_2")
                    .updateTo(UserInfoMilvus::getLoginName, "login_updated")
                    .doUpdate();
            assert r2 == 1;
            ThreadUtils.sleep(1000);
    ...
    public void testUpdatePassword() throws SQLException {
        try (Connection c = createConnection()) {
            ...
            // 2. Update Password
            int r = lambda.update(UserInfoMilvus.class)
                    .eq(UserInfoMilvus::getUid, "u_002")
                    .updateTo(UserInfoMilvus::getLoginPassword, "pass_002_new")
                    .doUpdate();
            assert r == 1;
            ThreadUtils.sleep(1000);
    ...
    public void testUpdateByMap() throws SQLException {
        try (Connection c = createConnection()) {
            ...
            int r = lambda.update(UserInfoMilvus.class)
                    .eq(UserInfoMilvus::getUid, "u_003")
                    .updateToSampleMap(updateMap)
                    .doUpdate();
            assert r == 1;
            ThreadUtils.sleep(1000);
    ...
    public void testUpdateVector() throws SQLException {
        try (Connection c = createConnection()) {
            ...
            int r = lambda.update(UserInfoMilvus.class)
                    .eq(UserInfoMilvus::getUid, "u_004")
                    .updateTo(UserInfoMilvus::getV, newVec)
                    .doUpdate();
            assert r == 1;
            ThreadUtils.sleep(1000);

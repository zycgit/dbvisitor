...
import net.hasor.realdb.milvus.dto1.UserInfoMilvus1;
import net.hasor.realdb.milvus.dto1.UserInfoMilvus1Mapper;
import net.hasor.realdb.milvus.dto2.UserInfoMilvus2;
import net.hasor.realdb.milvus.dto2.UserInfoMilvus2Mapper;
import net.hasor.realdb.milvus.dto3.UserInfoMilvus3;
import net.hasor.realdb.milvus.dto3.UserInfoMilvus3Mapper;
import net.hasor.realdb.milvus.dto3.UserInfoMilvus4Mapper;
import net.hasor.realdb.milvus.dto5.UserInfoMilvus5;
import net.hasor.realdb.milvus.dto5.UserInfoMilvus5Mapper;
import net.hasor.realdb.milvus.dto6.UserInfoMilvus6;
import net.hasor.realdb.milvus.dto6.UserInfoMilvus6Mapper;
...
public class MilvusMapperTest extends AbstractDbTest {
    private Connection createConnection() throws SQLException {
        try {
            ...
            url += "connectTimeout=30000&rpcDeadline=30000";
    ...
    public void using_mapper_file_1() throws Exception {
        Configuration config = new Configuration();
        config.options().mapUnderscoreToCamelCase(true);
        // Explicitly load XML if needed, but standard convention should find it in classpath
        // config.addMapper(UserInfoMilvus3Mapper.class); 
    ...
    public void using_mapper_api_5() throws Exception {
        ...
        try (Session session = config.newSession(createConnection())) {
            ...
            // test with aliasing (uid -> userId) defined in user-mapper-milvus-5.xml resultMap

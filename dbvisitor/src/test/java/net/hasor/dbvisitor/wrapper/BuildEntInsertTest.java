...
public class BuildEntInsertTest {
    ...
    public void insert_1() throws SQLException {
        InsertWrapper<AnnoUserInfoDTO> lambdaInsert = newLambda().insert(AnnoUserInfoDTO.class);
    ...
    public void insert_1_2map() throws SQLException {
        ...
        InsertWrapper<Map<String, Object>> lambdaInsert = newLambda().insert(AnnoUserInfoDTO.class).asMap();

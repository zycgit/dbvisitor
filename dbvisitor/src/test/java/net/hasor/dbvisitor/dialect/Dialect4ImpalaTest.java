 ...
 */
public class Dialect4ImpalaTest extends AbstractDialectTest {

    @Override
    protected ImpalaDialect findDialect() {
        return (ImpalaDialect) SqlDialectRegister.findOrCreate(JdbcHelper.IMPALA);
    }

    @Test
    public void dialect_impala_1() {
        ImpalaDialect dialect = this.findDialect();

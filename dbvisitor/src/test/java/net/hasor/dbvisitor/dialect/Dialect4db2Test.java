 ...
 */
public class Dialect4db2Test extends AbstractDialectTest {

    @Override
    protected Db2Dialect findDialect() {
        return (Db2Dialect) SqlDialectRegister.findOrCreate(JdbcHelper.DB2);
    }

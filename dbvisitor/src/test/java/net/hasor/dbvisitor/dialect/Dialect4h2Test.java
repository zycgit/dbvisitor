 ...
 */
public class Dialect4h2Test extends AbstractDialectTest {

    @Override
    protected H2Dialect findDialect() {
        return (H2Dialect) SqlDialectRegister.findOrCreate(JdbcHelper.H2);
    }

    @Test
    public void dialect_h2_1() {
        H2Dialect dialect = this.findDialect();

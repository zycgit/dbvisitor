...
import net.hasor.test.dal.Mapper2Dal;
...
public class Mapper2DalTest {
    ...
    public void loadMapping() throws Exception {
        ...
        this.dalRegistry.loadMapper(Mapper2Dal.class);
    }

    @Test
    public void bindTest_01() throws Throwable {
        DynamicSql parseXml = this.dalRegistry.findDynamicSql(Mapper2Dal.class, "testBind");

        String querySql1 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testBind.sql_1");
    ...
    public void chooseTest_01() throws Throwable {
        DynamicSql parseXml = this.dalRegistry.findDynamicSql(Mapper2Dal.class, "testChoose");

        String querySql1 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testChoose.sql_1");
        Map<String, Object> data1 = new HashMap<>();
        data1.put("title", "123");
    ...
    public void chooseTest_02() throws Throwable {
        ...
        String querySql1 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testChoose.sql_2");
        Map<String, Object> data1 = new HashMap<>();
        SqlBuilder builder1 = parseXml.buildQuery(data1, new TextBuilderContext());
        assert builder1.getSqlString().trim().equals(querySql1.trim());
    }
    ...
    public void foreachTest_01() throws Throwable {
        DynamicSql parseXml = this.dalRegistry.findDynamicSql(Mapper2Dal.class, "testForeach");

        String querySql1 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testForeach.sql_1");
        Map<String, Object> data1 = new HashMap<>();
    ...
    public void ifTest_01() throws Throwable {
        DynamicSql parseXml = this.dalRegistry.findDynamicSql(Mapper2Dal.class, "testIf");

        String querySql1 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testIf.sql_1");
        Map<String, Object> data1 = new HashMap<>();
        ...
        String querySql2 = loadString("/dbvisitor_coverage/dal_dynamic/mapper/Mapper2Dal_testIf.sql_2");

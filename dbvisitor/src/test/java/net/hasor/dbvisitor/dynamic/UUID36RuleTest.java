...
public class UUID36RuleTest {
    ...
    public void uuid36RuleTest_1() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{uuid36}").buildQuery(ctx1, new RegistryManager());
        ...
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{uuid36,:data}").buildQuery(ctx2, new RegistryManager());
        ...
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{uuid36, id = :data}").buildQuery(ctx3, new RegistryManager());

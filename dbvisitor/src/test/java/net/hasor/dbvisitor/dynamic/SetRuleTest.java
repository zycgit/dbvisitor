...
public class SetRuleTest {
    ...
    public void ruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set,name = :name}").buildQuery(ctx, new DynamicContext());
        ...
        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{set, name = :name}").buildQuery(ctx, new DynamicContext());
        ...
        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{set, name = ?}").buildQuery(ctx, new DynamicContext());
    ...
    public void ruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set  @{set,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("set  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set  @{set, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set  @{set,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("set  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set  @{set, name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder4.getSqlString().equals("set   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set 1=1 @{set,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set 1=1 @{set, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set 1=1 @{set,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set 1=1 @{set, name = ?}").buildQuery(ctx, new DynamicContext());
    ...
    public void ruleTest_4() throws SQLException {
        ...
        SqlBuilder sqlBuilder2 = sqlSegment2.buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set name = ? , age = ?");
        assert sqlBuilder2.getArgs().length == 2;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");
        assert ((MappedArg) sqlBuilder2.getArgs()[1]).getValue() == null; // TODO The use of both rule and location parameters is not supported.
    }
    ...
    public void ruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set}").buildQuery(ctx, new DynamicContext());
    ...
    public void ifruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifset,test,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("set name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifset,test, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifset,test,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("set name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder4.getSqlString().equals("set  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set  @{ifset,test,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("set  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set  @{ifset,test, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set  @{ifset,test,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("set  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set  @{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder4.getSqlString().equals("set   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder4.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((MappedArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");

        SqlBuilder sqlBuilder5 = DynamicParsed.getParsedSql("set name = :name ,  @{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
    ...
    public void ifruleTest_3_no() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test,name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("where 1=1 ");
        assert sqlBuilder1.getArgs().length == 0;

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test, name = :name}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("where 1=1 ");
        assert sqlBuilder2.getArgs().length == 0;

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test,name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("where 1=1 ");
        assert sqlBuilder3.getArgs().length == 0;

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder4.getSqlString().equals("where 1=1 ");
        assert sqlBuilder4.getArgs().length == 0;

        SqlBuilder sqlBuilder5 = DynamicParsed.getParsedSql("where name = :name and  @{ifset,test, name = ?}").buildQuery(ctx, new DynamicContext());
    ...
    public void ifruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifset}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifset,test}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("");
        assert sqlBuilder2.getArgs().length == 0;

        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifset,abc}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("");
        assert sqlBuilder3.getArgs().length == 0;

        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifset,test,abc}").buildQuery(ctx, new DynamicContext());
    ...
    public void badSqlTest_1() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where @{set,name = :name}").buildQuery(ctx, new DynamicContext());
    ...
    public void badSqlTest_2() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set,name = :name} and @{set,name = :name}").buildQuery(ctx, new DynamicContext());

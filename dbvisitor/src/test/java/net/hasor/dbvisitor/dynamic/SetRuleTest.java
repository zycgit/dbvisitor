...
public class SetRuleTest {
    ...
    public void ruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set,name = :name}").buildQuery(ctx, new RegistryManager());
        ...
        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{set, name = :name}").buildQuery(ctx, new RegistryManager());
        ...
        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{set,name = ?}").buildQuery(ctx, new RegistryManager());
        ...
        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{set, name = ?}").buildQuery(ctx, new RegistryManager());
    ...
    public void ruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set  @{set,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("set  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set  @{set, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("set   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set  @{set,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("set  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set  @{set, name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder4.getSqlString().equals("set   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set 1=1 @{set,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set 1=1 @{set, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set 1=1 @{set,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set 1=1 @{set, name = ?}").buildQuery(ctx, new RegistryManager());
    ...
    public void ruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{set,abc}").buildQuery(ctx, new RegistryManager());
    ...
    public void ifruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifset,test,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("set name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifset,test, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("set  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifset,test,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("set name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder4.getSqlString().equals("set  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set  @{ifset,test,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("set  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set  @{ifset,test, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("set   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set  @{ifset,test,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("set  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set  @{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder4.getSqlString().equals("set   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("set 1=1 , name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("set 1=1 @{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder4.getSqlString().equals("set 1=1 ,  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");

        SqlBuilder sqlBuilder5 = DynamicParsed.getParsedSql("set name = :name ,  @{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
    ...
    public void ifruleTest_3_no() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test,name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("where 1=1 ");
        assert sqlBuilder1.getArgs().length == 0;

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test, name = :name}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("where 1=1 ");
        assert sqlBuilder2.getArgs().length == 0;

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test,name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("where 1=1 ");
        assert sqlBuilder3.getArgs().length == 0;

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where 1=1 @{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder4.getSqlString().equals("where 1=1 ");
        assert sqlBuilder4.getArgs().length == 0;

        SqlBuilder sqlBuilder5 = DynamicParsed.getParsedSql("where name = :name and  @{ifset,test, name = ?}").buildQuery(ctx, new RegistryManager());
    ...
    public void ifruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifset}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifset,test}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder2.getSqlString().equals("");
        assert sqlBuilder2.getArgs().length == 0;

        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifset,abc}").buildQuery(ctx, new RegistryManager());
        assert sqlBuilder3.getSqlString().equals("");
        assert sqlBuilder3.getArgs().length == 0;

        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifset,test,abc}").buildQuery(ctx, new RegistryManager());
    ...
    public void badSqlTest_1() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where @{set,name = :name}").buildQuery(ctx, new RegistryManager());
    ...
    public void badSqlTest_2() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{set,name = :name} and @{set,name = :name}").buildQuery(ctx, new RegistryManager());

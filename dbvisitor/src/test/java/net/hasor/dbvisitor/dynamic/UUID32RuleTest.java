...
public class UUID32RuleTest {
    ...
    public void uuid32RuleTest_1() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{uuid32}").buildQuery(ctx1, new TestQueryContext());
        ...
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{uuid32,:data}").buildQuery(ctx2, new TestQueryContext());
        ...
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{uuid32, id = :data}").buildQuery(ctx3, new TestQueryContext());

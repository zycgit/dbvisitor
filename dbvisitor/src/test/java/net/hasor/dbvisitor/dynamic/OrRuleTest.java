...
public class OrRuleTest {
    ...
    public void ruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{or,name = :name}").buildQuery(ctx, new TestQueryContext());
        ...
        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{or, name = :name}").buildQuery(ctx, new TestQueryContext());
        ...
        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{or,name = ?}").buildQuery(ctx, new TestQueryContext());
        ...
        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{or, name = ?}").buildQuery(ctx, new TestQueryContext());
    ...
    public void ruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where  @{or,name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("where  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where  @{or, name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("where   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where  @{or,name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("where  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where  @{or, name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder4.getSqlString().equals("where   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where 1=1 @{or,name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("where 1=1 or name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where 1=1 @{or, name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("where 1=1 or  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where 1=1 @{or,name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("where 1=1 or name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where 1=1 @{or, name = ?}").buildQuery(ctx, new TestQueryContext());
    ...
    public void ruleTest_4() throws SQLException {
        ...
        // 第二个 @{or,age=?} 的位置参数 arg0 不存在（null），片段被自动丢弃，仅保留静态文本 " and "
    ...
    public void ruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{or}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{or,abc}").buildQuery(ctx, new TestQueryContext());
    ...
    public void ifruleTest_1() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifor,test,name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("where name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifor,test, name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("where  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifor,test,name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("where name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifor,test, name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder4.getSqlString().equals("where  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_2() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where  @{ifor,test,name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("where  name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where  @{ifor,test, name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("where   name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where  @{ifor,test,name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("where  name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where  @{ifor,test, name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder4.getSqlString().equals("where   name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");
    }
    ...
    public void ifruleTest_3() throws SQLException {
        ...
        //
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("where 1=1 @{ifor,test,name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("where 1=1 or name = ?");
        assert sqlBuilder1.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder1.getArgs()[0]).getValue().equals("abc");

        // more space char
        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("where 1=1 @{ifor,test, name = :name}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("where 1=1 or  name = ?");
        assert sqlBuilder2.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder2.getArgs()[0]).getValue().equals("abc");

        //
        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("where 1=1 @{ifor,test,name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("where 1=1 or name = ?");
        assert sqlBuilder3.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder3.getArgs()[0]).getValue().equals("123");

        // more space char
        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("where 1=1 @{ifor,test, name = ?}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder4.getSqlString().equals("where 1=1 or  name = ?");
        assert sqlBuilder4.getArgs().length == 1;
        assert ((SqlArg) sqlBuilder4.getArgs()[0]).getValue().equals("123");

        SqlBuilder sqlBuilder5 = DynamicParsed.getParsedSql("where name = :name and  @{ifor,test, name = ?}").buildQuery(ctx, new TestQueryContext());
    ...
    public void ifruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifor}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifor,test}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder2.getSqlString().equals("");
        assert sqlBuilder2.getArgs().length == 0;

        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifor,abc}").buildQuery(ctx, new TestQueryContext());
        assert sqlBuilder3.getSqlString().equals("");
        assert sqlBuilder3.getArgs().length == 0;

        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifor,test,abc}").buildQuery(ctx, new TestQueryContext());

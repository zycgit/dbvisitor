...
public class OrRuleTest {
    ...
    public void ruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{or}").buildQuery(ctx, new DynamicContext());
    ...
    public void ifruleTest_5() throws SQLException {
        ...
        SqlBuilder sqlBuilder1 = DynamicParsed.getParsedSql("@{ifor}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder1.getSqlString().equals("");
        assert sqlBuilder1.getArgs().length == 0;

        SqlBuilder sqlBuilder2 = DynamicParsed.getParsedSql("@{ifor,test}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder2.getSqlString().equals("");
        assert sqlBuilder2.getArgs().length == 0;

        SqlBuilder sqlBuilder3 = DynamicParsed.getParsedSql("@{ifor,abc}").buildQuery(ctx, new DynamicContext());
        assert sqlBuilder3.getSqlString().equals("");
        assert sqlBuilder3.getArgs().length == 0;

        SqlBuilder sqlBuilder4 = DynamicParsed.getParsedSql("@{ifor,test,abc}").buildQuery(ctx, new DynamicContext());

...
import net.hasor.dbvisitor.mapper.dto.ApiBasicConfigOneMapper;
...
public class ApiConfigOneMapperTest {
    ...
    public void configQuery_1() throws IOException {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery");
        assert def != null;
        assert def.getNamespace().equals(ApiBasicConfigOneMapper.class.getName());

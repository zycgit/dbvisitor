 ...
 * @version 2013-12-10
 */
public class ApiConfigOneMapperTest {
    @Test
    public void configQuery_1() throws Exception {
        MapperRegistry registry = new MapperRegistry();
        registry.loadMapper(ApiBasicConfigOneMapper.class);

        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery1");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
        ...
        assert ((SelectConfig) def.getConfig()).getResultMapSpace().equals("net.hasor.dbvisitor.mapper.dto.ApiBasicConfigOneMapper");
    ...
    public void configQuery_2() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery2");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
    ...
    public void configQuery_3() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery3");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
    ...
    public void configQuery_4() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery4");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
    ...
    public void configQuery_5() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configQuery5");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
    ...
    public void configInsert_1() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configInsert");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
    ...
    public void configInsert_2() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configInsertSelectKey");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
        assert def.getResultType() == long.class;
        assert ((InsertConfig) def.getConfig()).getType() == QueryType.Insert;
    ...
    public void configUpdate_1() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configUpdate");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
        assert def.getResultType() == long.class;
    ...
    public void configDelete_1() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configDelete");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
        assert def.getResultType() == long.class;
    ...
    public void configExecute_1() throws Exception {
        ...
        StatementDef def = registry.findStatement(ApiBasicConfigOneMapper.class, "configExecute");
        assert def != null;
        assert def.getConfigNamespace().equals(ApiBasicConfigOneMapper.class.getName());
        assert def.getResultType() == null;

...
import net.hasor.dbvisitor.lambda.dto.PointTable;
...
public class TemplateTest {
    ...
    public void insert_1() throws SQLException {
        Insert<PointTable> lambdaInsert = newLambda().insert(PointTable.class);
    ...
    public void update_1() throws SQLException {
        ...
        EntityUpdate<PointTable> lambdaUpdate = new LambdaTemplate().update(PointTable.class);
    ...
    public void delete_1() throws SQLException {
        EntityDelete<PointTable> lambdaDelete = new LambdaTemplate().delete(PointTable.class);

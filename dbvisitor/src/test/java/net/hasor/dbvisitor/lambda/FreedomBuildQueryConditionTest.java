...
public class FreedomBuildQueryConditionTest {
    ...
    public void queryBuild_and_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName = ?");
    ...
    public void queryBuild_ne_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName <> ?");
        ...
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName <> ?");
    ...
    public void queryBuild_is_null_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName IS NULL");
        assert boundSql2.getArgs()[0].equals(1);

        BoundSql boundSql3 = newLambda().queryFreedom("user_info")//
                .eq("seq", 1).or().isNull("loginName").getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName IS NULL");
        assert boundSql3.getArgs()[0].equals(1);
    }
    ...
    public void queryBuild_is_not_null_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName IS NOT NULL");
        assert boundSql2.getArgs()[0].equals(1);

        BoundSql boundSql3 = newLambda().queryFreedom("user_info")//
                .eq("seq", 1).and().isNotNull("loginName").getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName IS NOT NULL");
        assert boundSql3.getArgs()[0].equals(1);
    }
    ...
    public void queryBuild_in_1() throws SQLException {
        ...
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName IN ( ? , ? , ? )");
        assert boundSql1.getArgs()[0].equals(1);
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName IN ( ? , ? , ? )");
        assert boundSql2.getArgs()[0].equals(1);
        ...
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName IN ( ? , ? , ? )");
        assert boundSql3.getArgs()[0].equals(1);
    ...
    public void queryBuild_not_in_1() throws SQLException {
        ...
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName NOT IN ( ? , ? , ? )");
        assert boundSql1.getArgs()[0].equals(1);
        assert boundSql1.getArgs()[1].equals("a");
        assert boundSql1.getArgs()[2].equals("b");
        assert boundSql1.getArgs()[3].equals("c");
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName NOT IN ( ? , ? , ? )");
        assert boundSql2.getArgs()[0].equals(1);
        assert boundSql2.getArgs()[1].equals("a");
        assert boundSql2.getArgs()[2].equals("b");
        assert boundSql2.getArgs()[3].equals("c");
        ...
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName NOT IN ( ? , ? , ? )");
        assert boundSql3.getArgs()[0].equals(1);
        assert boundSql3.getArgs()[1].equals("a");
        assert boundSql3.getArgs()[2].equals("b");
        assert boundSql3.getArgs()[3].equals("c");
    ...
    public void queryBuild_like_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName LIKE CONCAT('%', ? ,'%')");
        assert boundSql2.getArgs()[0].equals(1);
        assert boundSql2.getArgs()[1].equals("abc");

        BoundSql boundSql3 = newLambda().queryFreedom("user_info")//
                .eq("seq", 1).and().like("loginName", "abc").getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName LIKE CONCAT('%', ? ,'%')");
        assert boundSql3.getArgs()[0].equals(1);
        assert boundSql3.getArgs()[1].equals("abc");
    }
    ...
    public void queryBuild_not_like_1() throws SQLException {
        ...
        assert boundSql2.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? OR loginName NOT LIKE CONCAT('%', ? ,'%')");
        assert boundSql2.getArgs()[0].equals(1);
        assert boundSql2.getArgs()[1].equals("abc");

        BoundSql boundSql3 = newLambda().queryFreedom("user_info")//
                .eq("seq", 1).and().notLike("loginName", "abc").getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE seq = ? AND loginName NOT LIKE CONCAT('%', ? ,'%')");
        assert boundSql3.getArgs()[0].equals(1);
        assert boundSql3.getArgs()[1].equals("abc");
    }

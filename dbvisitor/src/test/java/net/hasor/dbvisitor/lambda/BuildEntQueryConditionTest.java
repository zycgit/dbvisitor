...
public class BuildEntQueryConditionTest {
    ...
    public void queryBuild_0() {
        BoundSql boundSql1 = new LambdaTemplate().queryBySpace(AnnoUserInfoDTO.class).getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info");
    }

    @Test
    public void queryBuild_0_2map() {
        BoundSql boundSql1 = new LambdaTemplate().queryBySpace(AnnoUserInfoDTO.class).asMap().getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info");
    }

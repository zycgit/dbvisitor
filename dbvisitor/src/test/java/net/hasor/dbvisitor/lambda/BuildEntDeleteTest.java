...
public class BuildEntDeleteTest {
    ...
    public void deleteBuilder_1() {
        EntityDeleteOperation<AnnoUserInfoDTO> lambda = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class);
    ...
    public void deleteBuilder_1_2map() {
        MapDeleteOperation lambda = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class).asMap();
        lambda.allowEmptyWhere();
    ...
    public void deleteBuilder_4() {
        ...
        //case 1
        EntityDeleteOperation<AnnoUserInfoDTO> delCase1 = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class);
        ...
        EntityDeleteOperation<AnnoUserInfoDTO> delCase2 = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class);
    ...
    public void deleteBuilder_4_2map() {
        ...
        //case 1
        MapDeleteOperation delCase1 = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class).asMap();
        boolean isZyc1 = userInfo.getName().equals("zyc");
    ...
    public void bad_1() {
        try {
            EntityDeleteOperation<AnnoUserInfoDTO> lambdaDelete = new LambdaTemplate().deleteByEntity(AnnoUserInfoDTO.class);

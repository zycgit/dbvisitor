...
public class DoEntQueryTest {
    ...
    public void selectAll_forList_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<AnnoUserInfoDTO> users = new LambdaTemplate(c).queryByEntity(AnnoUserInfoDTO.class).queryForList();
    ...
    public void selectAll_forMapList_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<Map<String, Object>> users = new LambdaTemplate(c).queryByEntity(AnnoUserInfoDTO.class).queryForMapList();
    ...
    public void selectList_condition_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<AnnoUserInfoDTO> users = new LambdaTemplate(c).queryByEntity(AnnoUserInfoDTO.class)//
    ...
    public void selectObject_condition_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            AnnoUserInfoDTO tbUser = new LambdaTemplate(c).queryByEntity(AnnoUserInfoDTO.class)//
    ...
    public void selectMap_condition_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            Map<String, Object> tbUser = new LambdaTemplate(c).queryByEntity(AnnoUserInfoDTO.class)//

...
public class DoEntQueryTest {
    ...
    public void selectAll_forList_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<AnnoUserInfoDTO> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).queryForList();
    ...
    public void selectAll_forList_1_2map() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<Map<String, Object>> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).asMap()//
                    .queryForList();
    ...
    public void selectAll_forList_2() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<UserInfo> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).queryForList(UserInfo.class);
    ...
    public void selectAll_forList_2_2map() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<UserInfo> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).asMap()//
    ...
    public void selectAll_forMapList_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<Map<String, Object>> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).queryForMapList();
    ...
    public void selectAll_forCallBack_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            new LambdaTemplate(c).query(AnnoUserInfoDTO.class).query((rs, rowNum) -> {
    ...
    public void selectAll_forCallBack_1_2map() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<String> users = new ArrayList<>();
            new LambdaTemplate(c).query(AnnoUserInfoDTO.class).asMap()//
                    .query((rs, rowNum) -> {
                        users.add(rs.getString("user_name"));
                    });
    ...
    public void selectAll_forExtractor_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<Map<String, Object>> list = new LambdaTemplate(c).query(AnnoUserInfoDTO.class)//
    ...
    public void selectAll_forExtractor_1_2map() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            List<Map<String, Object>> list = new LambdaTemplate(c).query(AnnoUserInfoDTO.class).asMap()//
                    .query(new RowMapperResultSetExtractor<>(new ColumnMapRowMapper()));
    ...
    public void selectList_condition_1() throws Throwable {
        try (Connection c = DsUtils.h2Conn()) {
            ...
            List<AnnoUserInfoDTO> users = new LambdaTemplate(c).query(AnnoUserInfoDTO.class)//

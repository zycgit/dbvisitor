...
public class KeyTypeEntTest {
    ...
    public void autoId_overwrite() throws Throwable {
        ...
        try (Connection c = DsUtils.h2Conn()) {
            ...
            Insert<AnnoUserInfoDTO> insert = lambdaTemplate.insert(AnnoUserInfoDTO.class);
    ...
    public void autoId_usingUUID32() throws Throwable {
        ...
        try (Connection c = DsUtils.h2Conn()) {
            ...
            Insert<AnnoUserInfoDTO> lambdaInsert = lambdaTemplate.insert(AnnoUserInfoDTO.class);

...
public class FreedomBuildDeleteTest {
    ...
    public void deleteBuilder_1() throws SQLException {
        MapDelete lambda = new LambdaTemplate().deleteFreedom("user_info");
    ...
    public void deleteBuilder_4() throws SQLException {
        ...
        //case 1
        MapDelete delCase1 = new LambdaTemplate().deleteFreedom("user_info");
        ...
        MapDelete delCase2 = new LambdaTemplate().deleteFreedom("user_info");

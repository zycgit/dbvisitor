...
public class BuilderQueryTest extends AbstractDbTest {
    @Test
    public void queryBuilder1() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "abc").getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info WHERE login_name = ?");
        assert boundSql1.getArgs()[0].equals("abc");

        BoundSql boundSql2 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).eq(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql3 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().eq(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql4 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).ne(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql5 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().ne(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql6 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).gt(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql7 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().gt(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql8 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).ge(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql9 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().ge(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql10 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).lt(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql11 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().lt(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql12 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).le(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql13 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().le(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql14 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).isNull(UserInfo2::getLoginName).getBoundSql();
        ...
        BoundSql boundSql15 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().isNull(UserInfo2::getLoginName).getBoundSql();
        ...
        BoundSql boundSql16 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).isNotNull(UserInfo2::getLoginName).getBoundSql();
        ...
        BoundSql boundSql17 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().isNotNull(UserInfo2::getLoginName).getBoundSql();
        ...
        BoundSql boundSql18 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).in(UserInfo2::getLoginName, inData).getBoundSql();
        ...
        BoundSql boundSql19 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().in(UserInfo2::getLoginName, inData).getBoundSql();
        ...
        BoundSql boundSql20 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).notIn(UserInfo2::getLoginName, notInData).getBoundSql();
        ...
        BoundSql boundSql21 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().notIn(UserInfo2::getLoginName, notInData).getBoundSql();
        ...
        BoundSql boundSql22 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).between(UserInfo2::getLoginName, 2, 3).getBoundSql();
        ...
        BoundSql boundSql23 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().between(UserInfo2::getLoginName, 2, 3).getBoundSql();
        ...
        BoundSql boundSql24 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).notBetween(UserInfo2::getLoginName, 2, 3).getBoundSql();
        ...
        BoundSql boundSql25 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().notBetween(UserInfo2::getLoginName, 2, 3).getBoundSql();
        ...
        BoundSql boundSql26 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).like(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql27 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().notLike(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql28 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).likeRight(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql29 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().notLikeRight(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql30 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).likeLeft(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql31 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getSeq, 1).or().notLikeLeft(UserInfo2::getLoginName, "abc").getBoundSql();
        ...
        BoundSql boundSql32 = lambdaTemplate.queryBySpace(UserInfo2.class)//
        ...
        BoundSql boundSql33 = lambdaTemplate.queryBySpace(UserInfo2.class)//
        ...
        BoundSql boundSql34 = lambdaTemplate.queryBySpace(UserInfo2.class).eqBySample(new UserInfo2()).getBoundSql();
        assert boundSql34.getSqlString().equals("SELECT * FROM user_info");
        assert boundSql34.getArgs().length == 0;

        BoundSql boundSql35 = lambdaTemplate.queryBySpace(user_info.class).eqBySample(new user_info()).getBoundSql();
        assert boundSql35.getSqlString().equals("SELECT * FROM user_info");
    }

    @Test
    public void queryBuilder2() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class)//
        ...
        BoundSql boundSql2 = lambdaTemplate.queryBySpace(UserInfo2.class)//
    ...
    public void queryBuilder3() {
        ...
        try {
            LambdaTemplate lambdaTemplate = new LambdaTemplate();
            lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").eq(UserInfo2::getLoginName, "b").apply("limit 1")//
    ...
    @Test
    public void queryBuilder_or_1() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql3 = lambdaTemplate.queryBySpace(UserInfo2.class)//
        ...
        BoundSql boundSql4 = lambdaTemplate.queryBySpace(UserInfo2.class)//
    ...
    @Test
    public void queryBuilder_and_1() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();
    ...
    public void queryBuilder_nested_1() throws SQLException {
        ...
        BoundSql boundSql5 = lambdaTemplate.queryBySpace(UserInfo2.class)//
                .nested(nq0 -> {
                    nq0.nested(nq1 -> {
                        nq1.ge(UserInfo2::getCreateTime, 1); // >= ?
                        nq1.le(UserInfo2::getCreateTime, 2); // <= ?
    ...
    public void queryBuilder4() {
        try {
            LambdaTemplate lambdaTemplate = new LambdaTemplate();
            lambdaTemplate.queryBySpace(UserInfo2.class)//
    ...
    @Test
    public void queryBuilder5() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").asc(UserInfo2::getLoginName).getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM user_info WHERE login_name = ? ORDER BY login_name ASC");
        assert boundSql1.getArgs()[0].equals("a");

        BoundSql boundSql2 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").asc(UserInfo2::getLoginName, UserInfo2::getSeq).getBoundSql();
        ...
        BoundSql boundSql3 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").desc(UserInfo2::getLoginName).getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM user_info WHERE login_name = ? ORDER BY login_name DESC");
        assert boundSql3.getArgs()[0].equals("a");

        BoundSql boundSql4 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").asc(UserInfo2::getSeq).desc(UserInfo2::getLoginName).getBoundSql();
        assert boundSql4.getSqlString().equals("SELECT * FROM user_info WHERE login_name = ? ORDER BY seq ASC , login_name DESC");
        assert boundSql4.getArgs()[0].equals("a");

        BoundSql boundSql5 = lambdaTemplate.queryBySpace(UserInfo2.class).eq(UserInfo2::getLoginName, "a").orderBy(UserInfo2::getSeq).getBoundSql();
    ...
    @Test
    public void queryBuilder6() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class).applySelect("a, b, c, d")//
    ...
    @Test
    public void queryBuilder7() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class).select(UserInfo2::getLoginName, UserInfo2::getSeq)//
                .eq(UserInfo2::getSeq, 1).or().between(UserInfo2::getLoginName, 2, 3).getBoundSql();
    ...
    @Test
    public void queryBuilder8() throws SQLException {
        LambdaTemplate lambdaTemplate = new LambdaTemplate();

        BoundSql boundSql1 = lambdaTemplate.queryBySpace(UserInfo2.class).select(UserInfo2::getLoginName)//
                .eq(UserInfo2::getSeq, 1).or().between(UserInfo2::getLoginName, 2, 3).getBoundSql();

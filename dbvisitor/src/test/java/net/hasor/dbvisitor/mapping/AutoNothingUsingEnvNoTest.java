 ...
 */
public class AutoNothingUsingEnvNoTest extends AbstractDbTest {
    private MappingRegistry registry = new MappingRegistry();

    @Before
    public void beforeTest() throws Exception {
        this.registry = new MappingRegistry(null, TypeHandlerRegistry.DEFAULT, MappingOptions.buildNew().autoMapping(false));
        this.registry.loadMapper("/dbvisitor_coverage/basic_mapping/auto_nothing.xml");
    }

...
import net.hasor.dbvisitor.dialect.builder.Es7CommandBuilder;
 ...
 * @version 2025-12-31
 */
public class Es7Dialect extends AbstractDialect implements PageSqlDialect, ConditionSqlDialect {
    @Override

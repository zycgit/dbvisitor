 ...
 * @version : 2022-04-02
 */
public class DeleteLambdaForFreedom extends DeleteLambdaForMap {
    public DeleteLambdaForFreedom(TableMapping<?> tableMapping, RegistryManager registry, JdbcTemplate jdbc) {

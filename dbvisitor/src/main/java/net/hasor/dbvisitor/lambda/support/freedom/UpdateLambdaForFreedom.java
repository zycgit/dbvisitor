 ...
 * @version : 2022-04-02
 */
public class UpdateLambdaForFreedom extends UpdateLambdaForMap {
    public UpdateLambdaForFreedom(TableMapping<?> tableMapping, RegistryManager registry, JdbcTemplate jdbc) {

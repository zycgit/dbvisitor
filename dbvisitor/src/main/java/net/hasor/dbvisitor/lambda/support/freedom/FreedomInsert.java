 ...
 * @version 2022-04-02
 */
public class FreedomInsert extends MapInsertImpl {
    public FreedomInsert(TableMapping<?> tableMapping, MappingRegistry registry, JdbcTemplate jdbc, QueryContext ctx) {

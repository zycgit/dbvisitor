 ...
 * @version : 2022-04-02
 */
public class InsertLambdaForFreedom extends InsertLambdaForMap {
    public InsertLambdaForFreedom(TableMapping<?> tableMapping, RegistryManager registry, JdbcTemplate jdbc) {

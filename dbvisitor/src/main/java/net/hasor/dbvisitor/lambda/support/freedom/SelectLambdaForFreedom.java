 ...
 * @version : 2022-04-02
 */
public class SelectLambdaForFreedom extends SelectLambdaForMap {
    public SelectLambdaForFreedom(TableMapping<?> tableMapping, RegistryManager registry, JdbcTemplate jdbc) {

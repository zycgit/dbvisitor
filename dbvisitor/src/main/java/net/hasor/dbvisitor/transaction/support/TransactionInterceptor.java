...
public class TransactionInterceptor implements MethodInterceptor {
    ...
    public TransactionInterceptor(TransactionManager txManager) {
        this.txManager = Objects.requireNonNull(txManager, "transactionManager is null.");
    }
    ...
    public final Object invoke(final MethodInvocation invocation) throws Throwable {
        ...
        TransactionStatus tranStatus = this.txManager.begin(behavior, level);
        //1.只读事务
        ...
        try {
            ...
            if (!tranStatus.isCompleted()) {
                this.txManager.commit(tranStatus);
            }
        }
    }

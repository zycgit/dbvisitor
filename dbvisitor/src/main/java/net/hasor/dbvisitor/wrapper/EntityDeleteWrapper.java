 ...
 * @version 2022-04-02
 */
public interface EntityDeleteWrapper<T> extends               //
        BasicFunc<EntityDeleteWrapper<T>>,                    //
        DeleteExecute<EntityDeleteWrapper<T>>,                //
        QueryCompare<EntityDeleteWrapper<T>, T, SFunction<T>>,//
        EntityQueryCompare<EntityDeleteWrapper<T>> {

    MapDeleteWrapper asMap();
}

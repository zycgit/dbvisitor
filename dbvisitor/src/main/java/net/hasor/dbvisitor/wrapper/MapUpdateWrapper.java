 ...
 * @version 2022-04-02
 */
public interface MapUpdateWrapper extends                             //
        BasicFunc<MapUpdateWrapper>,                                  //
        UpdateExecute<MapUpdateWrapper, Map<String, Object>, String>, //
        QueryCompare<MapUpdateWrapper, Map<String, Object>, String> {
}

...
public interface DynamicSql {
    ...
    void buildQuery(SqlArgSource data, DynamicContext context, SqlBuilder sqlBuilder) throws SQLException;

    default SqlBuilder buildQuery(SqlArgSource data, DynamicContext context) throws SQLException {

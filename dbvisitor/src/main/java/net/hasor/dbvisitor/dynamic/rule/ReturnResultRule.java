...
/**
 * ReturnResult 规则，是一个特殊规则。在正常查询中不会产生任何效果，但通过 call 方法执行数据库 存储过程/函数调用 时可以用于决定结果集如何获取。
 * @author 赵永春 (zyc@hasor.net)
 * @version : 2021-06-05
 */
public final class ReturnResultRule implements SqlBuildRule {
    ...
    public static final SqlBuildRule INSTANCE            = new ReturnResultRule();

    private ReturnResultRule() {
    }

    @Override
    public String toString() {
        return "return/result [" + this.hashCode() + "]";
    }

...
/***
 *  copy form mysql driver 8.0.22
 */
public enum DriverMySqlTypes implements SQLType {
     ...
     */
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 65L, "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
    /**
     * DECIMAL[(M[,D])] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#DECIMAL
     */
    DECIMAL_UNSIGNED("DECIMAL UNSIGNED", Types.DECIMAL, BigDecimal.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 65L, "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    TINYINT("TINYINT", Types.TINYINT, Integer.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 3L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * TINYINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#TINYINT
     */
    TINYINT_UNSIGNED("TINYINT UNSIGNED", Types.TINYINT, Integer.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 3L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BOOL, BOOLEAN
     ...
     * Protocol: FIELD_TYPE_TINY = 1
     */
    BOOLEAN("BOOLEAN", Types.BOOLEAN, Boolean.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 3L, ""),
    /**
     ...
     */
    SMALLINT("SMALLINT", Types.SMALLINT, Integer.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 5L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * SMALLINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#SMALLINT
     */
    SMALLINT_UNSIGNED("SMALLINT UNSIGNED", Types.SMALLINT, Integer.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 5L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    INT("INT", Types.INTEGER, Integer.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 10L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * INT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#INT
     */
    INT_UNSIGNED("INT UNSIGNED", Types.INTEGER, Long.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 10L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    FLOAT("FLOAT", Types.REAL, Float.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 12L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#FLOAT
     */
    FLOAT_UNSIGNED("FLOAT UNSIGNED", Types.REAL, Float.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 12L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 22L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#DOUBLE
     */
    DOUBLE_UNSIGNED("DOUBLE UNSIGNED", Types.DOUBLE, Double.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 22L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FIELD_TYPE_NULL = 6
     */
    NULL("NULL", Types.NULL, Object.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 0L, ""),
    /**
     * TIMESTAMP[(fsp)]
    ...
    TIMESTAMP("TIMESTAMP", Types.TIMESTAMP, Timestamp.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     ...
     */
    BIGINT("BIGINT", Types.BIGINT, Long.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 19L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BIGINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#BIGINT
     */
    BIGINT_UNSIGNED("BIGINT UNSIGNED", Types.BIGINT, BigInteger.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 20L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    MEDIUMINT("MEDIUMINT", Types.INTEGER, Integer.class, DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 7L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * MEDIUMINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see DriverMySqlTypes#MEDIUMINT
     */
    MEDIUMINT_UNSIGNED("MEDIUMINT UNSIGNED", Types.INTEGER, Integer.class, DriverMySqlTypes.FIELD_FLAG_UNSIGNED | DriverMySqlTypes.FIELD_FLAG_ZEROFILL, DriverMySqlTypes.IS_DECIMAL, 8L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DATE
     ...
     */
    DATE("DATE", Types.DATE, Date.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 10L, ""),
    /**
     * TIME[(fsp)]
     ...
     */
    TIME("TIME", Types.TIME, Time.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 16L, "[(fsp)]"),
    /**
     * DATETIME[(fsp)]
     ...
     */
    DATETIME("DATETIME", Types.TIMESTAMP, Timestamp.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     * YEAR[(4)]
     ...
     */
    YEAR("YEAR", Types.DATE, Date.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 4L, "[(4)]"),
    /**
     ...
     */
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "(M) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * VARBINARY(M)
     ...
     * Protocol: FIELD_TYPE_VAR_STRING = 253
     */
    VARBINARY("VARBINARY", Types.VARBINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "(M)"),
    /**
     * BIT[(M)]
     * A bit-field type. M indicates the number of bits per value, from 1 to 64. The default is 1 if M is omitted.
     * Protocol: FIELD_TYPE_BIT = 16
     */
    BIT("BIT", Types.BIT, Boolean.class, 0, DriverMySqlTypes.IS_DECIMAL, 1L, "[(M)]"), // TODO maybe precision=8 ?
    /**
     ...
     */
    JSON("JSON", Types.LONGVARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 1073741824L, ""),
    /**
     ...
     */
    ENUM("ENUM", Types.CHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     ...
     */
    SET("SET", Types.CHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 64L, "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * TINYBLOB
     ...
     */
    TINYBLOB("TINYBLOB", Types.VARBINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 255L, ""),
    /**
     ...
     * Protocol:FIELD_TYPE_TINY_BLOB = 249
     */
    TINYTEXT("TINYTEXT", Types.VARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 255L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * MEDIUMBLOB
     ...
     */
    MEDIUMBLOB("MEDIUMBLOB", Types.LONGVARBINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 16777215L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_MEDIUM_BLOB = 250
     */
    MEDIUMTEXT("MEDIUMTEXT", Types.LONGVARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 16777215L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * LONGBLOB
     ...
     */
    LONGBLOB("LONGBLOB", Types.LONGVARBINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 4294967295L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_LONG_BLOB = 251
     */
    LONGTEXT("LONGTEXT", Types.LONGVARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 4294967295L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BLOB[(M)]
     ...
     */
    BLOB("BLOB", Types.LONGVARBINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "[(M)]"),
    /**
     ...
     * Protocol: FIELD_TYPE_BLOB = 252
     */
    TEXT("TEXT", Types.LONGVARCHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     ...
     */
    CHAR("CHAR", Types.CHAR, String.class, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 255L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BINARY(M)
     ...
     */
    BINARY("BINARY", Types.BINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 255L, "(M)"),
    /**
     * Top class for Spatial Data Types
     *
     * Protocol: FIELD_TYPE_GEOMETRY = 255
     */
    GEOMETRY("GEOMETRY", Types.BINARY, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, ""), // TODO check precision, it isn't well documented, only mentioned that WKB format is represented by BLOB
    /**
     ...
     * Has no protocol ID.
     */
    UNKNOWN("UNKNOWN", Types.OTHER, null, 0, DriverMySqlTypes.IS_NOT_DECIMAL, 65535L, "");

    /**
     * Get DriverMySqlTypes matching the full MySQL type name, for example "DECIMAL(5,3) UNSIGNED ZEROFILL".
     * Distinct *_UNSIGNED type will be returned if "UNSIGNED" is present in fullDriverMySqlTypesName.
     *
     * @param fullDriverMySqlTypesName
     *            full MySQL type name
     * @return DriverMySqlTypes
     */
    public static DriverMySqlTypes getByName(String fullDriverMySqlTypesName) {
        // TODO parse complex names like [NATIONAL] VARCHAR(M) [CHARACTER SET charset_name] [COLLATE collation_name]
        String typeName = "";
        if (fullDriverMySqlTypesName.indexOf("(") != -1) {
            typeName = fullDriverMySqlTypesName.substring(0, fullDriverMySqlTypesName.indexOf("(")).trim();
        } else {
            typeName = fullDriverMySqlTypesName;
        }
        ...
        if (StringUtils.indexOfIgnoreCase(typeName, "DECIMAL") != -1 || StringUtils.indexOfIgnoreCase(typeName, "DEC") != -1 || StringUtils.indexOfIgnoreCase(typeName, "NUMERIC") != -1 || StringUtils.indexOfIgnoreCase(typeName, "FIXED") != -1) {
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 ? DECIMAL_UNSIGNED : DECIMAL;
            ...
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? TINYINT_UNSIGNED : TINYINT;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "MEDIUMINT") != -1
                // IMPORTANT: "INT24" must be checked before "INT2"
                || StringUtils.indexOfIgnoreCase(typeName, "INT24") != -1 || StringUtils.indexOfIgnoreCase(typeName, "INT3") != -1 || StringUtils.indexOfIgnoreCase(typeName, "MIDDLEINT") != -1) {
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? MEDIUMINT_UNSIGNED : MEDIUMINT;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "SMALLINT") != -1 || StringUtils.indexOfIgnoreCase(typeName, "INT2") != -1) {
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? SMALLINT_UNSIGNED : SMALLINT;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "BIGINT") != -1 || StringUtils.indexOfIgnoreCase(typeName, "SERIAL") != -1 || StringUtils.indexOfIgnoreCase(typeName, "INT8") != -1) {
            // SERIAL is an alias for BIGINT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE.
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? BIGINT_UNSIGNED : BIGINT;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "POINT") != -1) {
            // also covers "MULTIPOINT"
            // IMPORTANT: "POINT" must be checked before "INT"
            return GEOMETRY; // TODO think about different DriverMySqlTypess for Spatial Data Types
            ...
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? INT_UNSIGNED : INT;
            ...
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? DOUBLE_UNSIGNED : DOUBLE;
         ...
         */) {
            ...
            return StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullDriverMySqlTypesName, "ZEROFILL") != -1 ? FLOAT_UNSIGNED : FLOAT;
            ...
            return MEDIUMBLOB;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "MEDIUMTEXT") != -1 || StringUtils.indexOfIgnoreCase(typeName, "LONG VARCHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "LONG") != -1) {
            // IMPORTANT: "MEDIUMTEXT" must be checked before "TEXT"
            // IMPORTANT: "LONG VARCHAR" must be checked before "VARCHAR"
            return MEDIUMTEXT;
        } else if (StringUtils.indexOfIgnoreCase(typeName, "VARCHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "NVARCHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "NATIONAL VARCHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "CHARACTER VARYING") != -1) {
            ...
            return GEOMETRY;
                ...
                || StringUtils.indexOfIgnoreCase(typeName, "CHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "NCHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "NATIONAL CHAR") != -1 || StringUtils.indexOfIgnoreCase(typeName, "CHARACTER") != -1) {
            return CHAR;
    ...
    public static DriverMySqlTypes getByJdbcType(int jdbcType) {
        switch (jdbcType) {
            case Types.BIGINT:
                return BIGINT;
            case Types.BINARY:
    ...
    public static boolean supportsConvert(int fromType, int toType) {
        // TODO use DriverMySqlTypess here ?
        switch (fromType) {
            /*
    ...
    public static boolean isSigned(DriverMySqlTypes type) {
        switch (type) {
            case DECIMAL:
            case TINYINT:
            case SMALLINT:
    ...
    /**
     *
     * @param DriverMySqlTypesName
     *            DriverMySqlTypesName
     * @param jdbcType
     *            jdbcType
     * @param javaClass
     *            javaClass
     ...
     *            params
     */
    private DriverMySqlTypes(String DriverMySqlTypesName, int jdbcType, Class<?> javaClass, int allowedFlags, boolean isDec, Long precision, String createParams) {
        this.name = DriverMySqlTypesName;
